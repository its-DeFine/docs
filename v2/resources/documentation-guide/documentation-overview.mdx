...
keywords:
  ...
  - ethos
  - objectives
'og:image': /snippets/assets/media/og-images/en/resource-hub.png
---
...
<Tip>
Have a suggestion for improvement? Check out our [Contribute to the Docs](./contributing/contribute-to-the-docs) page to share feedback or submit contributions.
</Tip>
...
2. **End-Users** - Looking for Livepeer Realtime Video or AI plug & play products
   - Start with: [Get Started](/v2/developers/navigator) → [Quickstarts](/v2/developers/navigator)

3. **Developers** - Building on the Livepeer Video or AI Protocol from tinkerers to founders & enterprise clients
   - Start with: [Developers Portal](/v2/developers/portal) → [Building on Livepeer](/v2/developers/navigator)
...
5. **Livepeer Token Holders** - Looking to stake LPT or participate in open governance
   - Start with: [Delegators Portal](/v2/delegators/portal) → [Staking & Delegation](/v2/delegators/delegation/overview)
...
For detailed information about these features, see the [Documentation Guide](./documentation-guide) and [Features & AI Integrations](./features/docs-features-and-ai-integrations) pages.

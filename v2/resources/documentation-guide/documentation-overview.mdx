...
2. **End-Users** — Looking for Livepeer Realtime Video or AI plug & play products
   - Start with: [Get Started](/developers/developer-guide) → [Quickstarts](/developers/developer-guide)

3. **Developers** — Building on the Livepeer Video or AI Protocol from tinkerers to founders & enterprise clients
   - Start with: [Developers Portal](/developers/portal) → [Building on Livepeer](/developers/developer-guide)

...
description: >-
  This page provides a comprehensive inventory of all files and folders in the
  `/snippets` directory. The snippets folder is the central location for all
  custom components, data, scripts, and assets used in the Livepeer
  documentation.
keywords:
  - livepeer
  - resources
...
### Scripts (`/operations/scripts/snippets/`)
...
Mintlify-specific authoring and workflow guidance now lives in `docs-guide/contributing/mintlify.mdx` and the internal canonical collation bundle under `docs-guide/canonical/collation-data/Mintlify/`.
...
import AboutOverview from "/snippets/composables/pages/about/concepts/overview.mdx";
```
...
- [Component Library](./component-library/overview) - Detailed component reference

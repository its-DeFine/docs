...
2. Compares with current version in `snippets/automations/globals/globals.jsx`
...
**Output file:** `snippets/automations/globals/globals.jsx`

**Audit note:** The March 9, 2026 freshness audit found version drift and a path mismatch inside this workflow. `globals.jsx` is the canonical automation output and any `.mdx` wrapper must remain a thin re-export instead of a second source of truth.
...
**File:** `operations/scripts/snippets/fetch-external-docs.sh`

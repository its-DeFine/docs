...
| --- | --- | --- | --- |
| AccordionGroupList | `stable` | `/snippets/components/displays/accordions/AccordionGroupList.jsx` | Generates N numbered accordion sections inside an AccordionGroup. |
| AccordionLayout | `stable` | `/snippets/components/displays/accordions/AccordionLayout.jsx` | Vertical stack layout with small gap, designed for accordion content sections. |
| BasicList | `planned` | `/snippets/components/displays/steps/Lists.jsx` | Planned list component — not yet implemented. |
...
| CardCarousel | `stable` | `/snippets/components/displays/grids/CardCarousel.jsx` | Paginated horizontal carousel with prev/next navigation and dot indicators. |
...
| DisplayCard | `stable` | `/snippets/components/displays/cards/CustomCards.jsx` | Card with icon, custom title row, and body content. |
| DynamicTable | `stable` | `/snippets/components/displays/tables/Table.jsx` | Renders structured data as a scrollable table with section separators and accessible region. |
...
| IconList | `planned` | `/snippets/components/displays/steps/Lists.jsx` | Planned icon list component — not yet implemented. |
| InlineImageCard | `stable` | `/snippets/components/displays/cards/CustomCards.jsx` | Card with inline image alongside content, using negative margin breakout. |
| InteractiveCard | `stable` | `/snippets/components/displays/cards/ShowcaseCards.jsx` | Single interactive card with hover effects. |
| InteractiveCards | `stable` | `/snippets/components/displays/cards/ShowcaseCards.jsx` | Multi-column layout of interactive cards. |
| ListSteps | `stable` | `/snippets/components/displays/steps/ListSteps.jsx` | Renders an array of step items inside Mintlify Steps component. |
| QuadGrid | `stable` | `/snippets/components/displays/grids/QuadGrid.jsx` | 2x2 grid with centred rotating icon overlay. Respects prefers-reduced-motion. |
...
| SearchTable | `stable` | `/snippets/components/displays/tables/SearchTable.jsx` | Filterable table wrapper with search input and category dropdown. |
| ShowcaseCards | `stable` | `/snippets/components/displays/cards/ShowcaseCards.jsx` | Paginated card layout with search, category, and product filtering. |
| Spacer | `stable` | `/snippets/components/wrappers/containers/Layout.jsx` | Spacer element with configurable size. |
| StepLinkList | `stable` | `/snippets/components/displays/steps/Lists.jsx` | Renders listItems as Mintlify Steps with GotoLink navigation. |
| StepList | `stable` | `/snippets/components/displays/steps/Lists.jsx` | Renders listItems as Mintlify Steps with title, icon, and content. |
| StyledStep | `stable` | `/snippets/components/displays/steps/Steps.jsx` | Single step with configurable icon, size, and colour. |
...
| UpdateLinkList | `stable` | `/snippets/components/displays/steps/Lists.jsx` | Renders update items as linked entries inside Mintlify Update component. |
| UpdateList | `planned` | `/snippets/components/displays/steps/Lists.jsx` | Planned update list component — not yet implemented. |
| WidthCard | `stable` | `/snippets/components/displays/cards/CustomCards.jsx` | Width-constrained card wrapper with configurable percentage width. |
...
**Import path**
```jsx
import { InteractiveCard } from '/snippets/components/displays/cards/ShowcaseCards.jsx'
```
**Metadata**
- Status: `stable`
...
**Import path**
```jsx
import { InteractiveCards } from '/snippets/components/displays/cards/ShowcaseCards.jsx'
```
**Metadata**
- Status: `stable`
- Accepts: `className, style, ...rest`
...
**Import path**
```jsx
import { ShowcaseCards } from '/snippets/components/displays/cards/ShowcaseCards.jsx'
```
**Metadata**
- Status: `stable`
- Accepts: `className, style, ...rest`

...
<Update label="f03e755" tags={["Commit"]} rss={{ title: "Livepeer.org Website f03e755", description: "Fix cursor-pointer on buttons and header visibility after primer (#7)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## f03e755
...
<Update label="2b56777" tags={["Commit"]} rss={{ title: "Livepeer.org Website 2b56777", description: "Update cost reduction claim from 10x to 6x on homepage (#4)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 2b56777
...
<Update label="48131e1" tags={["Commit"]} rss={{ title: "Livepeer.org Website 48131e1", description: "Add GA4 and Hotjar analytics (production only) (#1)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 48131e1
...
<Update label="646173b" tags={["Commit"]} rss={{ title: "Livepeer.org Website 646173b", description: "Replace Resend with Mailchimp for early access signups (#3)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 646173b
...
<Update label="c69527e" tags={["Commit"]} rss={{ title: "Livepeer.org Website c69527e", description: "Add redirects for old livepeer.org routes (#42)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## c69527e
...
<Update label="461a3d6" tags={["Commit"]} rss={{ title: "Livepeer.org Website 461a3d6", description: "Update Delegate links to explorer root and use \"Delegate Stake\" terminology (#41)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 461a3d6
...
<Update label="f82e3fd" tags={["Commit"]} rss={{ title: "Livepeer.org Website f82e3fd", description: "Align brand page hero with homepage grid system (#40)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## f82e3fd
...
<Update label="913c192" tags={["Commit"]} rss={{ title: "Livepeer.org Website 913c192", description: "Redesign Ecosystem section with bento layout (#39)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 913c192
...
<Update label="1322006" tags={["Commit"]} rss={{ title: "Livepeer.org Website 1322006", description: "Refine foundation page: add divider, constrain pillars heading, simplify grid (#38)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 1322006
...
<Update label="ec1a29e" tags={["Commit"]} rss={{ title: "Livepeer.org Website ec1a29e", description: "Add visual layer stack demo to brand page and refine grid system (#37)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## ec1a29e

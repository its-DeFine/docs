...
<Update label="4057063" tags={["Commit"]} rss={{ title: "LIPs 4057063", description: "Change status of LIP-107 from Draft to Proposed" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## 4057063
...
<Update label="7ca02b7" tags={["Commit"]} rss={{ title: "LIPs 7ca02b7", description: "Merge pull request #111 from shtukaresearch/LIP-491d6a" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## 7ca02b7
...
<Update label="787d1bc" tags={["Commit"]} rss={{ title: "LIPs 787d1bc", description: "LIP-107.md: update status to \"Proposed\"" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## 787d1bc
...
<Update label="97ffc34" tags={["Commit"]} rss={{ title: "LIPs 97ffc34", description: "Merge pull request #109 from shtukaresearch/LIP-491d6a" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## 97ffc34
...
<Update label="c756103" tags={["Commit"]} rss={{ title: "LIPs c756103", description: "Merge pull request #110 from livepeer/b3nnnp-patch-2" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## c756103
...
<Update label="e89791e" tags={["Commit"]} rss={{ title: "LIPs e89791e", description: "Update README.md" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## e89791e
...
<Update label="bdf4949" tags={["Commit"]} rss={{ title: "LIPs bdf4949", description: "LIP-107.md: change status to Last Call" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## bdf4949
...
<Update label="a3de461" tags={["Commit"]} rss={{ title: "LIPs a3de461", description: "Merge pull request #107 from shtukaresearch/LIP-491d6a" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## a3de461
...
<Update label="27b5386" tags={["Commit"]} rss={{ title: "LIPs 27b5386", description: "Assign LIP number 107 and retitle" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>February 2026</div>}>
  ## 27b5386
...
<Update label="9959ff4" tags={["Commit"]} rss={{ title: "LIPs 9959ff4", description: "Add discussion link." }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>January 2026</div>}>
  ## 9959ff4

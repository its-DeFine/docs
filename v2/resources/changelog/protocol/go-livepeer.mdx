...
<Update label="v0.8.10" tags={["Live AI", "BYOC", "Bug Fixes"]} rss={{ title: "go-livepeer v0.8.10", description: "Remote signer support for Live AI gateways, unified BYOC capability discovery, and broadcaster crash fix" }} description={<Subtitle variant="changelog">March 2026</div>}>
  ## v0.8.10
...
<Update label="v0.8.9" tags={["BYOC", "AI Models", "Bug Fixes"]} rss={{ title: "go-livepeer v0.8.9", description: "BYOC streaming workloads, new AI model support, WHEP playback improvements, and stability fixes" }} description={<Subtitle variant="changelog">January 2026</div>}>
  ## v0.8.9

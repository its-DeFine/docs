...
<Update label="1c09783" tags={["Commit"]} rss={{ title: "NaaP 1c09783", description: "feat(gateway): add ClickHouse HTTP query connector with static query support (#212)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 1c09783
  ...
  <ScrollBox maxHeight="150px" showHint={false}>
    ...
    * fix: require bodyTransform presence in conditional schema validation
    ...
    Made-with: Cursor
    ---------
    Co-authored-by: seanhanca <seanhanca@users.noreply.github.com>
...
<Update label="7428297" tags={["Commit"]} rss={{ title: "NaaP 7428297", description: "fix: migrate docker-compose v1 to docker compose v2 (#207)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 7428297
  ...
  <ScrollBox maxHeight="150px" showHint={false}>
    ...
    * fix: set DATABASE_URL_UNPOOLED for prisma db push in all scripts (#210)
    ...
    ---------
    Co-authored-by: Claude Opus 4.6 (1M context) <noreply@anthropic.com>
    Co-authored-by: seanhanca <103605970+seanhanca@users.noreply.github.com>
  </ScrollBox>
...
<Update label="ae132cc" tags={["Commit"]} rss={{ title: "NaaP ae132cc", description: "fix: remove deployment-manager plugin accidentally committed to main (#217)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## ae132cc
...
<Update label="4d1853d" tags={["Commit"]} rss={{ title: "NaaP 4d1853d", description: "chore: sync lockfile and fix CI Vercel build (Corepack + DB guard) (#215)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 4d1853d
...
<Update label="b5284af" tags={["Commit"]} rss={{ title: "NaaP b5284af", description: "feat(gateway): Agent Tool Interface — discovery, pricing, MCP, metrics, and master keys (#201)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## b5284af
...
<Update label="2accd67" tags={["Commit"]} rss={{ title: "NaaP 2accd67", description: "feat: add plugin development skill guide for agent-driven plugin creation (#204)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 2accd67
...
<Update label="21cfb0d" tags={["Commit"]} rss={{ title: "NaaP 21cfb0d", description: "chore: remove deprecated plugins (gateway-manager, orchestrator-manager, network-analytics, hello-world, todo-list) (#205)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 21cfb0d
...
<Update label="3a8930f" tags={["Commit"]} rss={{ title: "NaaP 3a8930f", description: "fix(auth): enhance middleware and auth context for better session management (#199)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## 3a8930f
...
<Update label="ff96d3e" tags={["Commit"]} rss={{ title: "NaaP ff96d3e", description: "fix(auth): handle missing user data in auth context (#194)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## ff96d3e
...
<Update label="e117b13" tags={["Commit"]} rss={{ title: "NaaP e117b13", description: "fix(gateway): fix TDZ error preventing connector detail page from rendering (#197)" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## e117b13

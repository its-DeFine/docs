...
description: >-
  Formal model of the Livepeer Treasury as a governance-controlled protocol
  asset allocator.
keywords:
  - livepeer
  - lpt
...
Canonical contract registry: [Contract Addresses](/v2/about/resources/livepeer-contract-addresses)

...
description: >-
  A list of exchanges where the Livepeer Token (LPT) is listed. Note: this
  information is fetched from Coingecko weekly
pageType: reference
...
import { exchangesData, exchangesMetadata } from '/snippets/automations/exchanges/exchangesData.jsx'

...
description: >-
  Protocol-level overview of LPT delegation, including stake attribution, reward
...
Canonical contract addresses: [Contract Registry](/v2/about/resources/livepeer-contract-addresses)
...
Because stake can migrate (subject to unbonding constraints), delegation functions as ongoing capital allocation instead of a one-time decision.

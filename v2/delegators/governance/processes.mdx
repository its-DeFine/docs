...
description: >-
  End-to-end governance process lifecycle including off-chain signaling, LIP
  drafting, on-chain proposal execution, and treasury coordination.
pageType: concept
keywords:
  - livepeer
  - lpt
...
<Steps>
 ...
 Only LPT that is bonded (staked) to an orchestrator has governance voting power. If you haven't bonded yet, start in the [Delegation Guide](/v2/delegators/delegation/delegation-guide).
  </Step>
...
- [Contract Registry](/v2/about/resources/livepeer-contract-addresses)

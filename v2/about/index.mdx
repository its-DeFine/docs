...
## Concepts
- [⚠️ Livepeer Actors](concepts/actors.mdx)
...
## Livepeer Protocol
- [Blockchain Contracts](livepeer-protocol/blockchain-contracts.mdx)
...
## Resources
- [⚠️ Blockchain Contracts](resources/blockchain-contracts.mdx)
- [⚠️ Gateways Vs. Orchestrators: What’s the Difference?](resources/gateways-vs-orchestrators.mdx)
- [Canonical Contract Addresses](resources/livepeer-contract-addresses.mdx)
- [Livepeer Whitepaper](resources/livepeer-whitepaper.mdx)
- [Technical Roadmap](resources/technical-roadmap.mdx)

### Compendium
- [About Livepeer — Glossary](resources/compendium/glossary.mdx)
- [Livepeer Glossary](resources/compendium/livepeer-glossary.mdx)

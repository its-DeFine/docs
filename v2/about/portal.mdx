 ...
 **Quick Intro**
 Get Situated */}
  ...
  <Columns cols={2}>
    <Card
      ...
      href="/v2/about/concepts/about-livepeer"
      arrow
    >
 A high-level introduction to the concepts, layers, and system boundaries that define Livepeer.
    ...
    <Card
      title="Mental Model"
      icon="brain"
      href="/v2/about/concepts/livepeer-stack"
      arrow
    >

...
'og:title': "Livepeer Contract Addresses on Arbitrum and Ethereum"
'og:description': >-
  Livepeer protocol contract addresses on Arbitrum One and Ethereum Mainnet.
...
<CardGroup cols={2}>
  ...
  <Card title="Livepeer Arbitrum LPT Bridge" icon="github" href="https://github.com/livepeer/arbitrum-lpt-bridge/tree/main/contracts" arrow>
    ...
    horizontal
  >
    {/* <Card title="Contract Changelog" icon="clock-rotate-left" href="/v2/resources/changelog/protocol/contracts" arrow> */}

...
<StyledSteps iconColor="var(--lp-color-accent)" titleColor="var(--accent)">
  <StyledStep title="Core Concepts" icon="lightbulb">
    **Build a mental model of what Livepeer is and how it works.**
    ...
    <LinkArrow href="/v2/about/concepts/about-livepeer" label="Start with concepts" newline={false} />
  </StyledStep>
  ...
  <StyledStep title="Protocol" icon="cube">
    **Understand the on-chain rules that coordinate the network.**
    ...
    <LinkArrow href="/v2/about/protocol/design" label="Explore the protocol" newline={false} />
  </StyledStep>
  ...
  <StyledStep title="Network" icon="circle-nodes">
    **See who does the work and how jobs flow through the system.**
    ...
    <LinkArrow href="/v2/about/network/design" label="Explore the network" newline={false} />
  </StyledStep>
...
<Columns cols={2}>
    <Card title="Core Mechanisms" icon="cubes-stacked" href="/v2/about/protocol/mechanisms" arrow>
 ...
 The Livepeer Token (LPT) utility and role in the protocol.
    ...
    <Card title="Governance Model" icon="gears" href="/v2/about/protocol/governance-and-treasury" arrow>
 The governance model of the Livepeer protocol.
    ...
    <Card title="Treasury" icon="money-bill" href="/v2/about/protocol/governance-and-treasury" arrow>
 The role of the treasury in the Livepeer protocol.
    ...
    <Card title="Protocol Economics" icon="coins" href="/v2/about/protocol/livepeer-token" arrow>
 The economics and reward model of the Livepeer protocol.
    ...
    <Card title="Technical Architecture" icon="code-fork" href="/v2/about/protocol/architecture" arrow>
...
<AccordionGroup>
  <Accordion title="I need the high-level picture first" icon="compass">
    ...
    <CardGroup cols={2}>
      <Card title="Livepeer Overview" icon="sparkles" href="/v2/about/concepts/about-livepeer" arrow>
        What Livepeer is, what it coordinates, and how protocol and network relate.
      </Card>
      <Card title="Mental Model" icon="brain" href="/v2/about/concepts/livepeer-stack" arrow>
  ...
  <Accordion title="I want to understand protocol mechanics and incentives" icon="cube">
    ...
    <CardGroup cols={2}>
      <Card title="Protocol Overview" icon="circle-info" href="/v2/about/protocol/design" arrow>
        Start here for the on-chain layer and what it governs.
      </Card>
      <Card title="Design Philosophy" icon="lightbulb" href="/v2/about/protocol/design" arrow>
  ...
  <Accordion title="I want to understand the execution network" icon="circle-nodes">
    ...
    <CardGroup cols={2}>
      <Card title="Network Overview" icon="diagram-project" href="/v2/about/network/design" arrow>
        Start here for actors, execution roles, and the network's job.
      </Card>
      <Card title="Job Lifecycle" icon="shuffle" href="/v2/about/network/job-pipelines" arrow>
  ...
  <Accordion title="I am evaluating Livepeer for a product or investment thesis" icon="scale-balanced">
    ...
    <CardGroup cols={2}>
      <Card title="Evaluating Livepeer" icon="clipboard-list" href="/v2/about/resources/faq" arrow>
        A curated route through the core pages for evaluation work.
      </Card>
      <Card title="Network Metrics" icon="chart-line" href="/v2/about/network/architecture" arrow>
  ...
  <Accordion title="I want to contribute or go deeper" icon="code-branch">
    ...
    <CardGroup cols={2}>
      <Card title="Contributor Orientation" icon="screwdriver-wrench" href="/v2/about/resources/knowledge-hub/livepeer-whitepaper" arrow>
  ...
  <Accordion title="I just need definitions or quick answers" icon="circle-question">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Glossary" icon="book-open" href="/v2/about/resources/faq" arrow>

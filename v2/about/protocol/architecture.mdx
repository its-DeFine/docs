...
<Tip> The Confluence upgrade (LIP-73) moved contracts from Ethereum mainnet to Arbitrum One, reducing protocol transaction costs while maintaining Ethereum's security guarantees through the rollup. </Tip>

...
## Further Resources
<Card title="Treasury Documentation" icon="piggy-bank" href="/v2/pages/06_lptoken/treasury/overview" arrow horizontal > See the Livepeer Treasury documentation in the [LP Token](/v2/pages/06_lptoken/treasury/overview) section for comprehensive technical details and guides on voting and porposals. </Card>
<Columns cols={2}>

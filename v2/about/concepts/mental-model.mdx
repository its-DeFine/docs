...
<CenteredContainer style={{ width: '90%' }}>
  <Quote>Livepeer is a crypto-economic coordination protocol that secures a global, on-demand GPU network optimised for low-latency video and AI, exposed through developer-friendly platforms and applications.</Quote>
...
<Accordion
          ...
          description={
              <AccordionLayout>
                ...
                <BadgeWrapper badges={[layerBadges.orchestrator]} />
              </AccordionLayout>
          }
      >
    > *"Raw atoms"*
...
<Accordion
          ...
          description={
              <AccordionLayout>
                ...
                <BadgeWrapper badges={[layerBadges.gateway, layerBadges.orchestrator]} />
              </AccordionLayout>
          }
          >
    > *"Bits move"*
 ...
 **Who provides it:**
 ...
 <Tip> Key Idea: <br/> This is the “brain” that replaces a centralized cloud control plane. It incentivizes correct behaviour, but does not run jobs. </Tip>

</Accordion>

<Accordion title="Layer 5: Economic & Security Layer" description={<AccordionLayout><Subtitle text="OSI: No direct equivalent | Protocol, Orchestrators" /><BadgeWrapper badges={[layerBadges.protocol, layerBadges.orchestrator]} /></AccordionLayout>}>
...
<Accordion title="Layer 6: Data & State Layer" description={<AccordionLayout><Subtitle text="OSI: Presentation /Data (conceptual) | Gateways, Orchestrators" /><BadgeWrapper badges={[layerBadges.gateway, layerBadges.orchestrator]} /></AccordionLayout>}>
    > *"What persists"*
...
<Accordion title="Layer 7: Platform Services" description={<AccordionLayout><Subtitle text="OSI: Application Services (conceptual) | Platforms, Gateways" /><BadgeWrapper badges={[layerBadges.platform, layerBadges.gateway]} /></AccordionLayout>}>
    > *"Batteries included"*
...
<Accordion title="Layer 8: Developer Interfaces" description={<AccordionLayout><Subtitle text="OSI: Presentation (developer-facing) | Platforms, Gateways" /><BadgeWrapper badges={[layerBadges.platform, layerBadges.gateway]} /></AccordionLayout>}>
...
<Accordion title="Layer 9: Developer Applications" description={<AccordionLayout><Subtitle text="OSI: Application | Applications" /><BadgeWrapper badges={[layerBadges.application]} /></AccordionLayout>}>
    > *"What builders ship"*
...
<Accordion title="Layer 10: End User" description={<AccordionLayout><Subtitle text="OSI: Application | End Users" /><BadgeWrapper badges={[layerBadges.user]} /></AccordionLayout>}>
...
<Note>Not Kafka. Not Airflow. Not Kubernetes. But conceptually: **A decentralised serverless GPU fabric with a cryptoeconomic control plane.**</Note>

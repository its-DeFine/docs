...
<Accordion title="The Case for Decentralisation" icon="network-wired">
    ...
    - **Resilience**: A distributed network of nodes is more resistant to failures, attacks, and censorship than a centralized system.
    ...
    - **Open Innovation**: An open, decentralized ecosystem encourages innovation from a diverse set of contributors, leading to more robust and feature-rich infrastructure.

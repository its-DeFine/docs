...
sidebarTitle: Protocol and Network
...
{/* Fluence co-founder Tom Trowbridge talks to Doug Petkanics, CEO and Founder at Livepeer.

Some of the topics they cover include:
Defining DePIN;
How Doug got into the open source software and DePIN space;
What is Livepeer, how it works and what makes it unique;
The benefits and unique opportunities decentralisation and open stack software brings into video;
How can the decentralised network be cheaper than traditional cloud platforms;
Livepeer adoption journey;
Being a mission driver founder;
Opportunities for DePIN to play a critical role in the AI movement. */}

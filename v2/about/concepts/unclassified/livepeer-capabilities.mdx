...
<StyledSteps iconColor="var(--accent)" titleColor="var(--accent)">
  ...
  <StyledStep title="GPU Yield" icon="microchip">
    Earn yield on idle GPU capacity. Operators with hardware already deployed plug into the network and earn ETH fees plus [LPT inflation rewards](/v2/about/protocol/livepeer-token) on hardware that would otherwise sit unused.
  </StyledStep>
...
<CardGroup cols={2}>
  <Card title="Livepeer Protocol & Network" icon="cube" href="/v2/about/concepts/unclassified/protocol-and-network" arrow horizontal>
    The system identity: what the protocol governs, what the network executes, and how the two relate.
  </Card>
  <Card title="Livepeer Architecture" icon="diagram-project" href="/v2/about/concepts/livepeer-stack" arrow horizontal>
    The structural map: layers, actors, and the on-chain and off-chain components that make capability possible.
  </Card>
  <Card title="Core Concepts" icon="graduation-cap" href="/v2/about/concepts/actors-and-capabilities" arrow horizontal>

...
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| Livepeer Docs — Set Pricing                     | [https://docs.livepeer.org/orchestrators/guides/set-pricing](https://docs.livepeer.org/orchestrators/guides/set-pricing)                                   | Official guide explaining how orchestrators set transcoding prices per pixel (Wei), including automatic price adjustment behavior. |
...
| Livepeer Docs — AI Orchestrators On‑Chain       | [https://na-36.mintlify.app/ai/orchestrators/onchain](https://na-36.mintlify.app/ai/orchestrators/onchain)                                                 | How AI orchestrators advertise service URIs on‑chain for gateway routing.                                                          |
...
* Livepeer docs do **not** define standard gateway pricing models; gateway operators and service providers set their own pricing. *(Verified absence)*

...
import { PageHeader, H2, H5,P } from '/snippets/components/display/frameMode.jsx'
...
<div className="frame-mode-container">
  ...
  >
  <br/>
  <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "30%", margin: "0 auto" }}>
    <Card title="go-livepeer" href="https://github.com/livepeer/go-livepeer" icon="github" arrow horizontal /> 
  </div>
  </PageHeader>
  {/* <Panel>
  <div style={{ display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", width: "80%", margin: "0 auto" }}>
      <P>
    Frame Mode Sucks
    </P>
    <Card title="go-livepeer" href="https://github.com/livepeer/go-livepeer" icon="github" arrow horizontal /> 

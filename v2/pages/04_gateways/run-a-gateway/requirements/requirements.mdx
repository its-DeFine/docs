  ...
  <Step title="Additional Requirements" icon="user-robot" titleSize="h3">
    ...
    <Tabs>
      <Tab title="Off-Chain Gateways">
        ...
        1. Have a GPU available (locally or cloud) with root or sudo access
        2. Setup the GPU as an Orchestrator per the [Orchestrator Setup Guide]('')
      </Tab>
      <Tab title="On-Chain Gateways">
        You will need a blockchain wallet and RPC to connect to the Livepeer Network and pay for services.

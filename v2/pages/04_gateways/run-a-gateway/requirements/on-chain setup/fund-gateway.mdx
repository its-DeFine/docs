...
<StyledSteps>
  <StyledStep title="Buy Ethereum">
    ...
    <Card icon="books" title="Exchanges that support Arbitrum One" href="/v2/pages/04_gateways/references/artibtrum-exchanges" arrow horizontal>
  ...
  <StyledStep title="Bridge to Arbitrum">
  ...
  <StyledStep title="Deposit to Gateway">

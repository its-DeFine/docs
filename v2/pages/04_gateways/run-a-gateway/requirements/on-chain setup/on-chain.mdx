...
<div
  style={{ border: '1px solid red', borderRadius: '8px', padding: '0 16px' }}
>
  ...
  private key. In c ase of accidental public exposure - remove any funds &
...
<Card
  ...
  title="Next Step"
  arrow
  href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain setup/fund-gateway/"
>
  {' '}
  Fund Your Gateway{' '}
</Card>

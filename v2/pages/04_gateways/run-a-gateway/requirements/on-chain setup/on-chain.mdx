...
<Columns cols={3}>
    ...
    <div>
        Related Pages
        - [Run a Gateway](/v2/pages/04_gateways/run-a-gateway/quickstart-a-gateway)
        - [Fund Gateway](/v2/pages/04_gateways/run-a-gateway/fund/fund-gateway)
        - [Install Gateway](/v2/pages/04_gateways/run-a-gateway/install/install-overview)
        - [RPC Reference](/v2/pages/04_gateways/references/arbitrum-rpc)
    </div>
</Columns>
</div> */}
...
In order to interact with the [Livepeer smart contracts](../../../../07_resources/references/contract-addresses) you will need to connect to an Arbitrum RPC.
...
- Never share your wallet private key. In c ase of accidental public exposure - remove any funds & change your wallet immediately
</div>
...
<Card icon="coins" title="Next Step" arrow href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain setup/fund-gateway/"> Fund Your Gateway </Card>

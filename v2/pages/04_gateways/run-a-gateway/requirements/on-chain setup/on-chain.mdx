...
import { BlinkingIcon } from '/snippets/components/links.jsx';
...
## <Icon icon="fast-forward" size={24} /> Easy Setup: Quickstart 

<Card title="Install Your Gateway Software First" href="/v2/pages/04_gateways/run-a-gateway/install/install-overview" icon="tools" horizontal arrow > -> then come back to this guide. </Card>
...
<Tabs>
    <Tab title="New Wallet & Keystore">
        <div style={{border: '1px solid #2b9a66', borderRadius: '8px', padding: '16px' }}>
        Livepeer will automatically create a new wallet & keystore for you if you do not provide an existing wallet address after first [installing your Gateway software](/v2/pages/04_gateways/run-a-gateway/install/install-overview).
        <br/>
        <br/>
    ...
    <Tab title="Existing Wallet, New Keystore">
        <div style={{border: '1px solid #2b9a66', borderRadius: '8px', padding: '16px' }}>
            Livepeer will automatically create a new keystore for you if you provide an existing wallet address.
            ...
            The software will detect no keystore exists for that address and ask you to:
                ...
                - Create the keystore file in the UTC format

            <br/>

            See [RPC URL](#rpc-url) for instructions on how to acquire an alternative Arbitrum RPC URL.
            <br/>
            <br/>
            Run the following command after [installing your Gateway software](/v2/pages/04_gateways/run-a-gateway/install/install-overview).
            ...
            livepeer -gateway \
                ...
                -ethKeystorePath=<PATH_TO_KEYSTORE>
            ```
        </div>
    </Tab>
</Tabs>
...
<br/>
<DoubleIconLink label="Configure Your Gateway" href="/v2/pages/04_gateways/run-a-gateway/configure/configuration-overview" iconLeft="download" /> 
...
<StyledStep title="ETH Keystore `-ethKeystorePath`" titleSize="h2">
    ...
    ### Create Keystore & Password Automatically (after install)
    <Tip>
    ...
    <Note> 
        If you are here, I assume you understand the security implications of exporting your private key and are able to vet & install any required software and convert linux bash commands to your own OS.
    ...
    <Steps>
        ...
        **Options to Create Keystore File**
        <Tabs>
            <Tab title="Opt 1: Using geth">
            Use Ethereum's development tool -> [geth](https://geth.ethereum.org/docs/)

            <Tabs>
                <Tab title="Linux/Mac Command">
                ```bash wrap lines icon="linux"
                # Install geth first

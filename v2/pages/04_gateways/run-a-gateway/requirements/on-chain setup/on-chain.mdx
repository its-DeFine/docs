...
<StyledStep title="ETH Keystore `-ethKeystorePath`">
    ...
    **Keystore File Format**
    ```json wrap lines Keystore File Format
    {  
    ...
    To bring your existing Ethereum account to Livepeer, you need to create a keystore file with your private key and place it in the correct directory structure.

    1. Export your private key from your existing wallet
    2. Create a keystore file using Livepeer devtools or Ethereum tooling.
    3. Place it in Livepeer's keystore directory
    4. Configure Livepeer to use your account
...
{/* 
    ...
    ```bash Windows
    %USERPROFILE%\.lpData\{network}\keystore\
    ```

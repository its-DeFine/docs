...
<Columns cols={3}>
    ...
    <div>
        Related Pages
        - [Run a Gateway](/v2/pages/04_gateways/run-a-gateway/quickstart/quickstart-a-gateway)
        - [Fund Gateway](/v2/pages/04_gateways/run-a-gateway/requirements/on-chain%20setup/fund-gateway)
...
<Card
  ...
  title="Next Step"
  arrow
  href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain%20setup/fund-gateway"
>
  {' '}
  Fund Your Gateway{' '}
</Card>
...
<StyledStep title="Funding Your Gateway">
    <Card title="Funding Your Gateway" href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain%20setup/fund-gateway" icon="piggy-bank" horizontal arrow >
...
<Expandable title="REMOVE ME: Old Stuff">
    ...
    **Windows**
    ...
    See <DoubleIconLink label="Fund Your Gateway" href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain%20setup/fund-gateway" iconLeft="coins" />

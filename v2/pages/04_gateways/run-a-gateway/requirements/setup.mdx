...
icon: clipboard-user
keywords: ["livepeer", "gateways", "run a gateway", "requirements", "setup", "gateway", "node", "learn", "hardware", "network"]
  ...
  <Step title="Additional Requirements" icon="user-robot" titleSize="h3">
    ...
    <Tabs>
      ...
      <Tab title="On-Chain Gateways" icon="link">
        ...
        <Card title="Go to On-Chain Setup Guide" icon="chain" href="/v2/pages/04_gateways/run-a-gateway/requirements/on-chain%20setup/on-chain" horizontal arrow>

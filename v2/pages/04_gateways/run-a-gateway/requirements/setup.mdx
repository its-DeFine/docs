  ...
  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
    <thead>
      <tr style={{ backgroundColor: '#2d9a67', color: 'white' }}>
        <th style={{ border: '1px solid #333', padding: '12px 16px', textAlign: 'left' }}>OS</th>
        <th style={{ border: '1px solid #333', padding: '12px 16px', textAlign: 'left' }}>Install Method</th>
        <th style={{ border: '1px solid #333', padding: '12px 16px', textAlign: 'left' }}>Gateway</th>
        <th style={{ border: '1px solid #333', padding: '12px 16px', textAlign: 'left' }}>Orchestrator / AI Worker</th>
        <th style={{ border: '1px solid #333', padding: '12px 16px', textAlign: 'left' }}>Notes</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>macOS (Intel / Apple)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Build from source (Go)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>✅ Yes</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>❌ No</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Best for local dev & routing. Docker often fails on macOS.</td>
      </tr>
      <tr>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Windows (Native)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Not supported</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>❌ No</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>❌ No</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>No native Windows binaries intended for production.</td>
      </tr>
      <tr>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Windows (WSL2 + Docker)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Docker (Linux via WSL2)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>✅ Yes</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>⚠️ Limited / fragile</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Effectively Linux-in-WSL. GPU needs NVIDIA + CUDA for WSL.</td>
      </tr>
      <tr>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Linux (Ubuntu recommended)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Docker or source build</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>✅ Yes</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>✅ Yes (NVIDIA GPU)</td>
        <td style={{ border: '1px solid #333', padding: '10px 16px' }}>Only OS suitable for production Orchestrators & AI workers.</td>
      </tr>
    </tbody>
  </table>
</div>

---
title: Run a Gateway
sidebarTitle: Provide Video & AI Services
description: "Gateways are essential infrastructure in the Livepeer network. 
...
```
    <div style={{ textAlign: 'center', fontStyle: 'italic', fontSize: '0.75rem', color: '#888' }}>Gateway Node Operations</div>

...
import { QuickStartSteps } from '/snippets/components/gateways/quickstartTabs.jsx';
import { dockerOffChainQuickstart } from '/snippets/data/gateways.jsx';
...
<QuickStartSteps dataSource={dockerOffChainQuickstart} />

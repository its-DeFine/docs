...
{/* These can be moved to the view using them */}
import { GatewayOffChainWarning, GatewayOnChainWarning, GatewayOnChainTTestnetNote, OrchAddrNote, TestVideoDownload, FfmpegWarning } from "/snippets/components/gateways/callouts.jsx";
...
import { LatestVersion } from '/snippets/components/release.jsx';
...
import DockerSupport from '/snippets/pages/gateways/run/quickstart/groups/docker/dockerSupport.mdx';
import LinuxSupport from '/snippets/pages/gateways/run/quickstart/groups/linux/linuxSupport.mdx';
...
<View title=" Docker" icon="docker" iconType="solid">
  ...
  <span style={{display: 'inline-flex', alignItems: 'flex-start', gap: "0.2rem"}}><Icon icon="linux" color="#ff9a0e" size={22}/><Badge> Linux </Badge>{" "} </span>
  <span style={{display: 'inline-flex', alignItems: 'flex-start', gap: "0.2rem"}}><Icon icon="windows" color="#14bbf7" size={22} /><Badge> Windows <Icon icon="warning" size={12} /></Badge> {" "}</span>
  <span style={{display: 'inline-flex', alignItems: 'flex-start'}}><Icon icon="apple" color="#60ba47" size={22} /><Badge> MacOS <Icon icon="warning" size={12}/></Badge></span>
  </span>

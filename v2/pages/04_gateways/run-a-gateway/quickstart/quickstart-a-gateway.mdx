...
import { GatewayOffChainWarning } from '/snippets/components/gateways/warnings.jsx';
...
# TEST
<QuickStartTabs offchainSteps = {<QuickStartSteps dataSource={dockerOffChainQuickstart} />} onchainSteps = {<QuickStartSteps dataSource={dockerOffChainQuickstart} />} />

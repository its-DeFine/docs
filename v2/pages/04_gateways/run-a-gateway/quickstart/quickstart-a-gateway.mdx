...
---
import { GatewayOffChainWarning, GatewayOnChainWarning } from "/snippets/components/gateways/warnings.jsx";
import {
...
import { LatestRelease, LatestReleaseUrl } from '/snippets/automationData/globals/globals.jsx';
import { CustomCodeBlock } from '/snippets/components/code.jsx';
import { TipWithArrow } from '/snippets/components/links.jsx';

# TEST
<QuickStartTabs offchainSteps = {<QuickStartSteps dataSource={dockerOffChainQuickstart} />} onchainSteps = {<QuickStartSteps dataSource={dockerOnChainQuickstart} />} />
...
## <Icon icon="linux" iconType="solid" size={32} /> Linux/Mac Quickstart Guide
  ...
  ## Reference Pages
  <Columns cols={2}>
    <Card title="Linux Installation Guide" href="../install/windows-install" arrow horizontal >
      View Full Installation Guide
    </Card>
    <Card title="Configuration Flags Reference" href="../../references/configuration-flags.mdx" arrow horizontal >
      Gateway Configuration Flag Guide
...
## Reference Pages
  <Columns cols={2}>
    <Card title="Windows Installation Guide" href="../install/windows-install" arrow horizontal >
      View Full Installation Guide
    </Card>
    <Card title="Configuration Flags Reference" href="../../references/configuration-flags.mdx" arrow horizontal >
      Gateway Configuration Flag Guide

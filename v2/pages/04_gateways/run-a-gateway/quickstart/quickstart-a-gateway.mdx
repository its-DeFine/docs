...
{/* DATA & CODE */}
import { DOCKER_CODE, DOCKER_YML, BASH_CODE, AI_TEST_COMMANDS, CONFIG_FILES } from '/snippets/data/gateways/code.jsx';
...
import { GatewayOffChainWarning, GatewayOnChainWarning, OrchAddrNote, TestVideoDownload } from "/snippets/components/gateways/callouts.jsx";
  ...
  <Tab title="Off-Chain Gateway" icon="floppy-disk">
    ...
    <Steps titleSize="h3">
       ...
       *See flag details below:*
        ...
        <Expandable title="transcodingOptions.JSON Example"> 
            <CustomCodeBlock
      ...
      <Step title="Test Gateway">
        <Tabs>
          ...
          <Tab title="AI" icon="user-robot">
            ...
            Test your HTTP Ingest Stream:
            <CustomCodeBlock
              {...BASH_CODE.testHTTPingest}
              wrap
            />

            Check if your Gateway AI worker is running:
            <CustomCodeBlock
              {...BASH_CODE.checkStatus}
              wrap
            />

            Check Orchestrator's available Capabilities
            <CustomCodeBlock

...
import { DoubleIconLink, BlinkingIcon } from '/snippets/components/links.jsx'
    ...
    <Tab title="Use Docker (Recommended)">
        <StyledSteps iconColor="#18794e" titleColor="#fff" lineColor="" iconSize="24px">
            ...
            <StyledStep title="Test the AI Gateway">
                Follow the instructions in the <DoubleIconLink label="AI Gateway Testing Guide" href="/ai/gateways/test-gateway" iconLeft="link" /> to verify that the AI Gateway is operational.
            </StyledStep>
        </StyledSteps>
    </Tab>

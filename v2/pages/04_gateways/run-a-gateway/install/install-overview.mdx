...
Please ensure you have read the <DoubleIconLink label="Setup Checklist" href="/v2/pages/04_gateways/run-a-gateway/requirements/setup" iconLeft="link" /> before proceeding.
...
<Card title="On-Chain Setup Requirements" href="/v2/pages/04_gateways/run-a-gateway/install/on-chain" icon="chain" arrow horizontal >

...
description: 'This page explains how to find and broker Orchestrator AI & Video Offerings via your Gateway for Livepeer Application consumption.'
sidebarTitle: 'Discover & Connect Services'
---
import { CustomCallout } from '/snippets/components/links.jsx';
...
<br />
> - **Orchestrators** publish services to the Livepeer Marketplace;
> - **Gateways** filter & connect application requests to those services.
<br />
<br />

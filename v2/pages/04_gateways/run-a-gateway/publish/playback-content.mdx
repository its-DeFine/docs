---
title: Playback Content using VLC Media Player
# icon: circle-play
description: 'How to playback content from a Livepeer Gateway with VLC Media Player'
sidebarTitle: 'Playback Content'
---

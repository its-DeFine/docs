...
<table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
  ...
  <tbody>
    <tr style={{ borderBottom: '1px solid #333', backgroundColor: '#1a1a1a' }}>
      <td style={{ padding: '10px 16px', color: '#2d9a67', fontWeight: '500' }}>Livepeer Cloud Community Gateway</td>
      <td style={{ padding: '10px 16px', fontFamily: 'monospace' }}><code>https://dream-gateway.livepeer.cloud</code></td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333', backgroundColor: 'transparent' }}>
      <td style={{ padding: '10px 16px', color: '#2d9a67', fontWeight: '500' }}>Livepeer Studio Gateway</td>
      <td style={{ padding: '10px 16px', fontFamily: 'monospace' }}><code>https://livepeer.studio/api/beta/generate</code></td>
    </tr>
  </tbody>
</table>
</div>

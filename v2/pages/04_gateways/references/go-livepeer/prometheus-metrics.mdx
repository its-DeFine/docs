...
keywords: ["livepeer", "gateways", "references", "go livepeer", "prometheus metrics", "prometheus", "metrics"]
...
[monitoring is enabled](/v2/pages/04_gateways/run-a-gateway/monitor/monitor-and-optimise).

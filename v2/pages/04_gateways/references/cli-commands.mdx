...
keywords: ["livepeer", "gateways", "references", "cli commands", "gateway", "commands", "reference"]
"og:image": "/snippets/assets/domain/04_GATEWAYS/social-preview-gateways.jpg"
---

# Livepeer CLI Commands
<Card title="CLI Tools Codebase" href="/wiki/livepeer/go-livepeer#4.4" icon="github" arrow horizontal>

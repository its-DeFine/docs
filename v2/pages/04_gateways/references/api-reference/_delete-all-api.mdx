...
<Note>
These endpoints are available on AI Workers and Gateways running the Livepeer AI Runner.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Image to Image" icon="wand-magic-sparkles" href="#image-to-image">
    Apply transformations to images
  </Card>
  <Card title="Image to Video" icon="video" href="#image-to-video">
    Generate video from an image
  </Card>
  <Card title="Upscale" icon="up-right-and-down-left-from-center" href="#upscale">
    Upscale images to higher resolution
  </Card>
  <Card title="Audio to Text" icon="microphone" href="#audio-to-text">
    Transcribe audio to text
  </Card>
  <Card title="Segment Anything 2" icon="object-group" href="#segment-anything-2">

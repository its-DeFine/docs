...
<CardGroup cols={2}>
  <Card title="Livepeer Studio SDKs" icon="video" href="/010_products/products/livepeer-studio/overview/sdks-overview" arrow>
    TypeScript, Go, Python, and React SDKs for Livepeer Studio API
  </Card>
  <Card title="Network SDKs" icon="network-wired" href="/v2/pages/03_developers/technical-references/sdks" arrow>
...
- **Full Documentation**: [Livepeer Studio SDKs](/010_products/products/livepeer-studio/overview/sdks-overview)
...
- See [Network SDKs](/v2/pages/03_developers/technical-references/sdks) for details

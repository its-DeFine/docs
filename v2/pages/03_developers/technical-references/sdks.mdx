...
<CardGroup cols={2}>
  <Card title="Livepeer Studio SDKs" icon="video" href="/platforms/products/livepeer-studio/overview/sdks-overview" arrow>
...
- **Full Documentation**: [Livepeer Studio SDKs](/platforms/products/livepeer-studio/overview/sdks-overview)

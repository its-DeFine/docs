...
<Columns cols={2}> 
    <Card title="Livepeer Showcase" icon="clapperboard-play" href="/v2/home/project-showcase/showcase" horizontal arrow> Explore Projects </Card>
    <Card title="Livepeer Products" icon="film-canister" href="../../platforms/products-portal" horizontal arrow > Explore Products</Card>
</Columns>

...
<Columns cols={3}>
  ...
  <Tile href="https://www.mintlify.com/docs/components/tiles" title="Accordion" description="Two variants">
    <img src="../../assets/hero/hero_gateways.png" alt="Accordion component preview" className="block dark:hidden" />
    <img src="../../assets/hero/hero_gpu.png" alt="Accordion component preview (dark mode)" className="hidden dark:block" />
  </Tile>
  <Tile href="https://www.mintlify.com/docs/components/tiles" title="Accordion" description="Two variants">

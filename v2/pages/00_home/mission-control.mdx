...
<PortalContentContainer>
  ...
  <Columns cols={3}>
    ...
    <Card
      ...
      href="../03_developers/livepeer-real-time-video/video-streaming-on-livepeer/README"
      arrow="true"
    ...
    <Card
      ...
      href="../03_developers/ai-inference-on-livepeer/ai-pipelines/overview"
      arrow="true"
    ...
    <Card
      ...
      href="../02_community/community-portal"
      arrow="true"
    ...
    <Card
      ...
      href="/v2/pages/00_home/project-showcase/showcase"
      arrow="true"
    ...
    <Card
      ...
      href="../04_gateways/gateways-portal"
      arrow="true"
    ...
    >
      ...
      href="../03_developers/builder-opportunities/dev-programs"
      arrow="true"

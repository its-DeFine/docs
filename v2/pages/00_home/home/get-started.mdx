...
<Columns cols={2}>
    ...
    <DisplayCard icon="eyes" title="Just Browsing">
            ...
            <LinkArrow label="Trending at Livepeer" href="/v2/pages/02_community/livepeer-community/trending-topics" description="See what's new across the Livepeer blog, forum, and socials." newline={false} />
    </DisplayCard>
    <DisplayCard icon="camera-movie" title="Real-time AI Video">
        ...
        <LinkArrow label="Daydream" href="/v2/pages/010_products/products/daydream" newline={false} description="Real-time AI video creation." />
...
- [Daydream](/v2/pages/010_products/products/daydream) - Learn more about Daydream, Livepeer's real-time AI video platform.

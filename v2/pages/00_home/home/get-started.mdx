...
<Columns cols={2}>
    ...
    <DisplayCard icon="camera-movie" title="Real-time AI Video">
        ...
        <LinkArrow label="Livepeer Studio" description="Try out Livepeer Studio, a hosted video platform." newline={false} href="/v2/pages/010_products/products/livepeer-studio" />
    </DisplayCard>

...
and experienced, the underlying infrastructure matters more than ever.
...
<br/>
<Card
  title={<span style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "1.5rem", lineHeight: 1 }}><Icon icon="video-camera" size={28} color="var(--accent)" /> See what creators are building on Livepeer</span>}

...
<br/>
  The Livepeer Foundation makes decisions in the following areas:
...
### Livepeer DAO
While not officially called the Livepeer DAO, the Livepeer protocol is governed by a collective of Livpeer (LP) tokenholders who decide on the direction of the network via [on-chain proposals](https://explorer.livepeer.org/voting) and an [on-chain treasury]().
...
Anyone who holds Livepeer tokens (LPT) is a member of the Livepeer DAO, though in order to participate in voting & governance, a non-zero [delegated stake](../../06_delegators/delegating-lpt/how-to-delegate-lpt) of LPT is required.

<Note> Even if you are not a tokenholder (or do not have a non-zero delegated stake), you can still participate in the Livepeer ecosystem by joining the community and influencing the direction of the network indirectly through [forum discussion](https://forum.livepeer.org/t/about-the-governance-category/1059) and collaboration. </Note>
...
<br/>
<Accordion title="See more about the Livepeer DAO" icon="camera-retro" defaultOpen >
  **Role in Ecosystem**
  - The Livepeer tokenholders (collectively unofficially called the Livepeer DAO in this documentation) are the ultimate decision-makers on funding and protocol changes. 
  - They elect to fund SPEs, approve Foundation proposals, and ratify protocol upgrades - [LIPs](https://github.com/livepeer/LIPs).
  - The Livepeer DAO are the key decision-makers and stakeholders for the long-term health and collective product direction of the Livepeer network.

  **DAO Members**

  Livepeer (LPT) DAO members, with non-zero delegated stake, include:

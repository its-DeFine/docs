...
## Related Resources
<Columns cols={2}>
   <Card title="Governance Model" href="/v2/pages/01_about/livepeer-protocol/governance-model" icon="ballot-check" arrow > Read more about the technical details of the governance model. </Card> 

...
<Accordion title="More on Cyrptoeconomic Primitive Advantages">
...
**Protocol** <Badge color="green"> Livepeer Protocol </Badge>
...
**Applications and Products** <Badge color="purple"> Gateways </Badge> <Badge color="orange"> Products </Badge>

A set of developer‑facing tools and applications (APIs, SDKs, apps) which expose the network's capabilities in a usable way.
- the **products** expose the network's capabilities in a usable way.
...
You can think of Livepeer as an [OSI stack](https://en.wikipedia.org/wiki/OSI_model) where the “cloud control plane” is replaced by a cryptoeconomic protocol, and persistent storage is optional, external, and secondary to real-time streamed compute.
...
<Accordion title="Layer 1: Physical Compute & Resource Layer" description={<Subtitle text="OSI: Physical" />}>
    > *"Raw atoms"*
...
<Accordion title="Layer 2: Transport & Media Substrate" description={<Subtitle text="OSI: Data Link / Transport" />}>
    > *"Bits move"*
...
<Accordion title="Layer 3: Distributed Execution Network" description={<Subtitle text="OSI: Network" />}>
...
<Accordion title="Layer 4: Crypto-Economic Coordination Layer" description={<div><Subtitle text="OSI: Session / Control Plane (conceptual)" /><br/><Badge color="green"> Livepeer Protocol </Badge></div>}>

...
keywords: ["livepeer", "lpt", "mechanics", "bonding", "staking", "rewards", "slashing", "arbitrum", "smart contracts"]
...
| Component | Type | Address (Arbitrum One) | Explorer | Source |
|---|---|---|---|---|
| Controller | Core | `0xD8E8328501E9645d16Cf49539efC04f734606ee4` | [Arbiscan](https://arbiscan.io/address/0xD8E8328501E9645d16Cf49539efC04f734606ee4) | [GitHub](https://github.com/livepeer/protocol) |
| LivepeerToken (LPT) | Core | `0x289ba1701C2F088cf0faf8B3705246331cB8A839` | [Arbiscan](https://arbiscan.io/address/0x289ba1701C2F088cf0faf8B3705246331cB8A839) | [GitHub](https://github.com/livepeer/protocol) |
| Minter | Core | `0xc20DE37170B45774e6CD3d2304017fc962f27252` | [Arbiscan](https://arbiscan.io/address/0xc20DE37170B45774e6CD3d2304017fc962f27252) | [GitHub](https://github.com/livepeer/protocol) |
| BondingManager (Proxy) | Upgradeable | `0x35Bcf3c30594191d53231E4FF333E8A770453e40` | [Arbiscan](https://arbiscan.io/address/0x35Bcf3c30594191d53231E4FF333E8A770453e40) | [GitHub](https://github.com/livepeer/protocol/blob/confluence/contracts/bonding/BondingManager.sol) |
| BondingManager (Target) | Implementation | `0xF62C30242fccd3a46721f155d4d367De3fD5B3b3` | [Arbiscan](https://arbiscan.io/address/0xF62C30242fccd3a46721f155d4d367De3fD5B3b3) | [GitHub](https://github.com/livepeer/protocol/blob/confluence/contracts/bonding/BondingManager.sol) |
| RoundsManager (Proxy) | Upgradeable | `0xdd6f56DcC28D3F5f27084381fE8Df634985cc39f` | [Arbiscan](https://arbiscan.io/address/0xdd6f56DcC28D3F5f27084381fE8Df634985cc39f) | [GitHub](https://github.com/livepeer/protocol/blob/confluence/contracts/rounds/RoundsManager.sol) |
| RoundsManager (Target) | Implementation | `0x92d804Ed49D92438aEA6fe552BD9163aacb7E841` | [Arbiscan](https://arbiscan.io/address/0x92d804Ed49D92438aEA6fe552BD9163aacb7E841) | [GitHub](https://github.com/livepeer/protocol/blob/confluence/contracts/rounds/RoundsManager.sol) |

<Note>
The protocol routes user calls through proxy contracts; implementation ("Target") contracts contain the executable logic.
</Note>
...
sequenceDiagram
    ...
    participant BM as BondingManagerProxy
    participant RM as RoundsManagerProxy
...
- [livepeer/protocol repository](https://github.com/livepeer/protocol) (contract source, confluence branch for Arbitrum)

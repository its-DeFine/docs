...
### **Broadcaster (-> Gateway)** 
<span><Badge icon="exclamation" color="orange">Deprecated Term</Badge> See **Gateways**
A job submitter—often a user-facing service—that sends video or AI jobs into the network via a gateway.</span>

...
<Info>
For a detailed audit of all automations, see the [Automations & Workflows Audit Report](/tasks/reports/20-automations-workflows-audit-report.md).
</Info>
...
5. Leaves dynamic label mapping (`area:*`, `priority:*`, `kind:*`) to `issue-auto-label.yml`
...
- [Audit Report](/tasks/reports/20-automations-workflows-audit-report.md) - Comprehensive automation audit

...
<Tabs>
  ...
  <Tab title="Custom Icon">
    <GotoLink label="Documentation" relativePath="/v2/pages/00_home/mission-control" icon="book" />
  </Tab>
  <Tab title="Code">
```jsx
<GotoLink label="Getting Started" relativePath="/get-started" />
...
```jsx
<LinkArrow href="https://livepeer.org" label="Visit Livepeer" />
<LinkArrow href="/v2/pages/00_home/mission-control" label="Documentation" newline={false} />
```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="Example">
    <AccordionTitleWithArrow text="Learn More" href="/v2/pages/00_home/mission-control" />
  </Tab>
  <Tab title="Code">
```jsx
<AccordionTitleWithArrow text="Learn More" href="/v2/pages/00_home/mission-control" />

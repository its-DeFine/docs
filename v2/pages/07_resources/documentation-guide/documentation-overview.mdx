...
1. **Understanding Livepeer** — All users interested in understanding the Livepeer Network, Protocol & Ecosystem
   - Start with: [About Livepeer](/01_about/about-portal) → [Core Concepts](/01_about/core-concepts/livepeer-core-concepts)

2. **End-Users** — Looking for Livepeer Realtime Video or AI plug & play products
   - Start with: [Get Started](/03_developers/building-on-livepeer/developer-guide) → [Quickstarts](/03_developers/building-on-livepeer/developer-guide)

3. **Developers** — Building on the Livepeer Video or AI Protocol from tinkerers to founders & enterprise clients
   - Start with: [Developers Portal](/03_developers/developer-portal) → [Building on Livepeer](/03_developers/building-on-livepeer/developer-guide)

4. **GPU Providers & Data Centres** — Bringing compute to the Livepeer Network
   - Start with: [Orchestrators Portal](/v2/pages/05_orchestrators/orchestrators-portal) → [Setting Up an Orchestrator](/05_orchestrators/setting-up-an-orchestrator/overview)

5. **Livepeer Token Holders** — Looking to stake LPT or participate in open governance
   - Start with: [LP Token Portal](/06_lptoken/token-portal) → [Staking & Delegation](/06_lptoken/delegation/overview)

6. **Gateway Operators** — Running infrastructure to route jobs on the network
   - Start with: [Gateways Portal](/04_gateways/gateways-portal) → [Run a Gateway](/04_gateways/run-a-gateway/run-a-gateway)

...
2. **End-Users** — Looking for Livepeer Realtime Video or AI plug & play products
   - Start with: [Get Started](/developers/building-on-livepeer/developer-guide) → [Quickstarts](/developers/building-on-livepeer/developer-guide)

3. **Developers** — Building on the Livepeer Video or AI Protocol from tinkerers to founders & enterprise clients
   - Start with: [Developers Portal](/03_developers/developer-portal) → [Building on Livepeer](/developers/building-on-livepeer/developer-guide)

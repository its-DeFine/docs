---
title: "Quickstart"
description: "Create an account, get an API key, and add live or on-demand video in under 5 minutes."
---
...
<Info>
  Use separate accounts or [projects](/010_products/products/livepeer-studio/guides/managing-projects) for development and production to keep environments isolated.
</Info>
...
- [Create a livestream](/010_products/products/livepeer-studio/guides/create-livestream) — Create a stream and get a stream key and playback ID.
- [Upload an asset](/010_products/products/livepeer-studio/guides/upload-asset) — Upload video files and play them back.
- [Listen to asset events](/010_products/products/livepeer-studio/guides/listen-to-events) — Use webhooks to react when assets are ready or fail.
- [SDKs overview](/010_products/010_products/products/livepeer-studio/overview/sdks-overview) — TypeScript, Go, Python, and React.
- [API overview](/010_products/010_products/products/livepeer-studio/overview/api-overview) — Authentication and API basics.

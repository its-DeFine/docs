...
sidebarTitle: FAQ
description: >-
  Answers to common orchestrator questions and step-by-step fixes for the most frequent errors — installation,
  networking, job routing, AI pipelines, and earnings.
...
{/*
  PURPOSE:
  Frequently asked questions for orchestrator operators.
  Quick answers to common operational, economic, and technical questions.

  SECTION HOME: Resources
  CROSS-REFS:
  - Monitoring & Tools > Troubleshooting - detailed problem solving
  - All guide sections - detailed answers
*/}

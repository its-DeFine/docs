...
description: >-
  Cost categories, revenue sources, viability thresholds, and a decision matrix for evaluating whether running a
  Livepeer Orchestrator makes sense for your situation.
...
rest of the cost model, viability checks, and trade-offs behind each path.

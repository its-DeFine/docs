...
description: >-
  How gateways discover and select your orchestrator — the discovery mechanisms, multi-factor selection algorithm, what
  you can do to receive more work, and how to use the gateway Loki API to understand routing decisions.

...
description: >-
  How AI inference works on the Livepeer network — pipeline types, the batch vs live-video distinction, hardware
  requirements, and how jobs flow from application to your GPU node.

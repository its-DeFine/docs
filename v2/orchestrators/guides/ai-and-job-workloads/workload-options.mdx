...
description: >-
  The four job types an orchestrator can process — transcoding, batch AI inference, Cascade live-video AI, and LLM
  inference — with hardware requirements, pricing models, routing mechanics, and how to choose which workloads to run.

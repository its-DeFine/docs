...
description: >-
  Configure your orchestrator node to serve both video transcoding and AI inference jobs from a single go-livepeer
  process.
...
Verify:
- Mermaid diagrams use hardcoded theme colours from /snippets/components/config/MermaidColours.jsx

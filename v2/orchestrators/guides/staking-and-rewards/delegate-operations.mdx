...
- **Delegation guide:** [Delegation Guide](/v2/delegators/delegation/delegation-guide) — protocol-level guide to the bonding process
...
<CardGroup cols={2}>
  ...
  <Card title="LPT Token" icon="coins" href="/v2/delegators/about/purpose">

...
description: >-
  An Experimental AI Prompt for setting up your GPU as a Livepeer Orchestrator. Add AI inference pipelines to an
  existing go-livepeer transcoding node — hardware check, aiModels.json configuration, and startup command update.
...
<CardGroup>
  <Card
    ...
    icon="image"
    href="/v2/orchestrators/guides/workloads-and-ai/batch-ai-setup"
  >
  ...
  <Card
    ...
    icon="video"
    href="/v2/orchestrators/guides/workloads-and-ai/realtime-ai-setup"
  >
...
- [AI Pipeline Configuration](/v2/orchestrators/guides/workloads-and-ai/ai-workloads-guide) — advanced aiModels.json options, multi-GPU setup, external containers, and optimization flags {/* REVIEW: confirm path */}

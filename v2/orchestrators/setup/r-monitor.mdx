---
title: Monitoring Your Orchestrator Setup
sidebarTitle: Monitor
description: >-
  Monitor node health, GPU performance, and earnings with Prometheus and the
  Livepeer Explorer.
keywords:
  - livepeer
  - orchestrators
...
---
{/* Should include community tooling for doing this as well as link to Explorer */}
...
<Columns cols={2}>
  ...
  <Card title="Rewards and fees" icon="coins" href="../advanced/rewards-and-fees" arrow />
  <Card title="FAQ" icon="circle-question" href="../resources/faq" arrow />
</Columns>

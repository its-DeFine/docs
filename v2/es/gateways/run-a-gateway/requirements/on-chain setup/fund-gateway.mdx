---
title: Financia el Livepeer Gateway
sidebarTitle: Financiar Gateway
icon: ethereum
description: >-
  Los siguientes pasos lo guiarán a agregar fondos a su cuenta de ETH Gateway,
  incluida la financiación de la cuenta ETH en Ethereum Mainnet, transferir los
  fondos a la red L2 de Arbitrum y luego usar la CLI de Livepeer para asignar
  las cantidades adecuadas de depósito y reserva.
keywords:
  - livepeer
  - gateways
  - run a gateway
...
---
{/* codex-i18n:  */}
import { StyledSteps, StyledStep } from '/snippets/components/layout/steps.jsx'

<Warning> Complete: needs review </Warning>

# Añadir fondos a la billetera del Gateway

Para operar el Gateway en producción, necesitas tener Ethereum en [Arbitrum Uno](https://arbitrum.io/) Blockchain L2 - que es donde se implementan los contratos inteligentes de Livepeer y que proporciona la capa de pago para Livepeer.

---
title: 'Ejecutar un Gateway: Guía de inicio rápido'
description: >-
  Obtén un nodo de Gateway dual de IA / video Livepeer y ejecútalo localmente o
  en la red Livepeer.
sidebarTitle: Ejecutar un Gateway de inicio rápido
keywords:
  - livepeer
  - gateways
  - run a gateway
...
---
{/* codex-i18n:  */}
{/* DATA & CODE */}
...
--- 
# Vamos (-Livepeer) ! <Icon icon="face-grin-wink" size={26} />
Esta página te permitirá configurar un Nodo de Puerta de Livepeer para <Badge color="blue">Video</Badge> Transcodificación & <Badge color="purple">AI</Badge> enrutamiento de servicios de canal.

*Este guía incluye:* 
- Configuración para <span><Icon icon="link" size={20}/> **on-chain _(production)_** and <Icon icon="floppy-disk" size={20}/> **off-chain _(local/dev)_** Livepeer Gateway nodes </span>
- Guías de instalación para <span><Icon icon="docker" size={20} /> **Docker _(recommended)_** </span> y <span><Icon icon="laptop-code" size={20} /> **Pre-Built Binaries**. </span>

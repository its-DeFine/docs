...
---
{/* codex-i18n:  */}
import { DisplayCard } from '/snippets/components/display/customCards.jsx'

El video es integral para el éxito de muchas de las aplicaciones que usamos a diario.<br />
...
8. **Aplicaciones de telemedicina** (consultas médicas remotas centradas en video)
9. **Plataformas de educación en línea** como Coursera/Udacity (aprendizaje basado en video)
10. **Plataformas de eventos virtuales** (transmisión de Devcon/ETH CC, impulsada por infraestructuras como Livepeer)

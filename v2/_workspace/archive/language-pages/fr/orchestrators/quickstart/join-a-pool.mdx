---
title: Rejoignez un Pool
description: >-
  Contribuez votre capacité GPU à un orchestrateur Livepeer existant et gagnez
  des récompenses sans exécuter l'infrastructure du protocole.
sidebarTitle: Rejoignez un Pool
keywords:
  - livepeer
  - orchestrators
...
---
{/* codex-i18n:  */}
...
Rejoindre un pool géré par la communauté est une façon simple de démarrer sur le réseau Livepeer.
Les pools sont gérés par des opérateurs expérimentés qui assurent les opérations quotidiennes du réseau. 
...
Les opérateurs de pool gèrent des tâches telles que le staking, la délégation et la gestion du nœud orchestrateur, vous n'avez donc pas besoin de posséder LPT ou de gérer des actions sur la chaîne.
Le compromis est que vous avez moins de contrôle sur les prix, le routage et les décisions de délégation, et les revenus sont partagés avec l'opérateur du pool. 

...
sidebarTitle: Contributions OSS
description: >-
  Comment contribuer aux dépôts open source de Livepeer -- des corrections de
  documentation à l'ingénierie du protocole -- incluant un guide pour chaque
  dépôt principal et son processus de contribution.
keywords:
  - livepeer
  - open source
  - oss
...
---
{/* codex-i18n:  */}
...
Livepeer est entièrement open source. Chaque composant central -- du nœud du protocole au runner IA en passant par la documentation -- est maintenu publiquement sur GitHub et accueille les contributions de tous.

Vous n'avez pas besoin d'écrire du code pour apporter une contribution significative. Les améliorations de la documentation, les rapports de bugs, la couverture de tests et le soutien à la communauté sont tous appréciés.
...
Cela s'applique à tous les dépôts Livepeer :
...
- **Contributing guide:** See [Contribute to the Docs](/v2/fr/resources/documentation-guide/contribute-to-the-docs) for the full workflow including pull request steps, review timeline, and style guidance.
...
Tous les dépôts Livepeer suivent un code de conduite communautaire basé sur le [Contributor Covenant](https://www.contributor-covenant.org/). Les contributeurs sont censés être constructifs, bienveillants et patients. Consultez le code de conduite lié dans chaque dépôt avant de participer.

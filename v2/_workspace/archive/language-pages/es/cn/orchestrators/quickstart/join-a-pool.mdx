---
title: 加入一个池
description: 向现有的 Livepeer 协调器贡献GPU容量，并在不运行协议基础设施的情况下获得奖励。
sidebarTitle: 加入一个池
keywords:
  - livepeer
  - orchestrators
...
---
{/* codex-i18n:  */}
...
加入由社区运营的池是开始使用 Livepeer 网络的一种低门槛方式。
池由经验丰富的运营商管理，他们负责网络的日常运营。 
...
池运营商处理诸如质押、委托和管理协调器节点等任务，因此您不需要 LPT 或处理链上操作。
权衡是您对定价、路由和委托决策的控制较少，并且收益将与池运营商共享。 

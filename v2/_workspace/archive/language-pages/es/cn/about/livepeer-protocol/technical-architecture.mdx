...
title: 技术概览
sidebarTitle: 技术架构
description: 对 Livepeer 协议的技术概览。
keywords:
  - livepeer
  - about
  - livepeer protocol
...
---
{/* codex-i18n:  */}
{/* This page describes:
...
注释
- 区块链处理经济激励和协调，而`go-livepeer`网络节点处理媒体处理和 AI 推理的计算密集型工作。
- 链上合约验证工作并处理支付，但不执行实际的转码/AI 推理
- `go-livepeer`节点与区块链通信以提交工作证明并索取奖励
- 此架构使协议能够扩展，同时通过链上验证保持经济安全

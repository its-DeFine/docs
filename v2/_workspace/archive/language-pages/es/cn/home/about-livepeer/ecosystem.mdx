...
title: Livepeer 组织结构
sidebarTitle: 生态系统
description: 了解 Livepeer 的组织结构，包括 Livepeer 基金会、Livepeer 公司，以及 Livepeer 社区 在治理网络未来中的关键作用。
keywords:
  - livepeer
  - home
  - introduction
...
---
{/* codex-i18n:  */}
...
Livepeer 也受到一套核心价值观的驱动，这些价值观指导其开发、运营和社区互动。

- **创新**: 拥抱新想法和技术，以保持领先。
- **协作**: 与社区共同构建，促进开放对话和共享所有权。
- **可及性**: 让前沿的视频和 AI 工具对所有人可用，无论其技术背景如何。
- **社区**: 与社区共同构建，促进开放对话和共享所有权。

鉴于此，Livepeer 致力于不仅是开放、可及的架构，还致力于一个 *贡献型组织结构*，它为合适的人提供合适的激励，专注于正确的事物。 

## 实体

Livepeer 的项目结构已经演变，以平衡专注的核心团队和不断增长的社区治理模型。
多个实体在 Livepeer 生态系统中扮演不同角色： 
{/* - Livepeer Inc. 
- Livepeer Foundation
...
本节描述每个实体及其相互关系，包括关键产品（如 Livepeer Studio 和 Daydream，
战略重点，以及团队成员对其协作的见解。

### Livepeer Inc.
Livepeer Inc 是 Livepeer 协议背后的原始创始公司。Livepeer Inc 构建了核心网络基础设施，并持续推动产品开发。

Livepeer Inc 当前的重点是为实时 AI 视频时代的 Livepeer 网络实现产品市场匹配（PMF）。
...
<br/>
  Livepeer 基金会是 Livepeer 生态系统中的战略协调者，并在以下领域做出决策：
  - 为 Livepeer 定义战略目标
  - 设计举措以加速或引导向目标的进展
  - 利用可用资源，招聘并协调任务小组以执行这些举措
...
### Livepeer DAO
虽然官方未称其为 Livepeer DAO，但 Livepeer 协议由一群 Livpeer (LP) 代币持有者集体治理，他们通过 [链上提案](https://explorer.livepeer.org/voting) 和一个 [链上金库](https://explorer.livepeer.org/treasury)。

正如 Rich O'Grady，Livepeer 基金会负责人所解释的：
<FrameQuote
  source="Launching the Livepeer Foundation"
  href="https://forum.livepeer.org/t/launching-the-livepeer-foundation/2849"
  align="left"
...
DAO 成员集体是协议升级、网络增长提案和金库分配的最终决策者。

任何持有（并已委托）Livepeer 代币（LPT）的人都是 Livepeer DAO 的成员，并可参与投票与治理。 
...
<Accordion title="See more about the Livepeer DAO" icon="camera-retro" >
  ...
  **On-Chain Treasury**
    ...
    - In 2022, Livepeer launched the [On-Chain Treasury](/v2/cn/lpt/treasury/overview) to fund the long-term growth and sustainability of the network.
  ...
  - Any tokenholder can participate in governance by delegating their tokens to a delegator or running a delegate node themselves.
    <span>
      ...
      <LinkArrow
        ...
        href="/v2/cn/lpt/delegation/overview"
        target="_blank"
        newline={false}
        />
        {" )."} 
...
特殊目的实体（SPE）是以使命为驱动、由社区资助的团队，旨在为 Livepeer 网络执行特定项目。它们通过链上金库获得资金，并对代币持有者负责，从而实现更快、更专注的进展。

...
description: Una visión general técnica del protocolo Livepeer.
keywords:
  - livepeer
  - about
  - livepeer protocol
...
---
{/* codex-i18n:  */}
{/* This page describes:
...
Notas
- La cadena de bloques gestiona los incentivos económicos y la coordinación, mientras `go-livepeer` los nodos de red manejan el trabajo computacionalmente intensivo de procesamiento de medios e inferencia de IA.
- Los contratos en cadena verifican el trabajo y manejan los pagos, pero no realizan la transcodificación real/inferencia de IA
- `go-livepeer` los nodos se comunican con la cadena de bloques para enviar pruebas de trabajo y reclamar recompensas
- Esta arquitectura permite que el protocolo escale mientras mantiene la seguridad económica mediante la verificación en cadena
...
Livepeer puede modelarse como una arquitectura en capas:

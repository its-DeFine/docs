---
title: Únete a un Pool
description: >-
  Contribuye capacidad GPU a un orquestador Livepeer existente y gana
  recompensas sin ejecutar la infraestructura del protocolo.
sidebarTitle: Únete a un Pool
keywords:
  - livepeer
  - orchestrators
...
---
{/* codex-i18n:  */}
...
Unirse a un pool gestionado por la comunidad es una forma de bajo esfuerzo para comenzar con la red Livepeer.
Los pools son operados por operadores experimentados que gestionan las operaciones diarias de la red. 
...
Los operadores de pools manejan tareas como staking, delegación y gestión del nodo orquestador, por lo que no necesitas tener LPT ni ocuparte de acciones en cadena.
La contrapartida es que tienes menos control sobre los precios, el enrutamiento y las decisiones de delegación, y los ingresos se comparten con el operador del pool. 

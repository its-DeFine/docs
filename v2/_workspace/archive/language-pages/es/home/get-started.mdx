...
<Columns cols={2}>
    ...
    <DisplayCard icon="eyes" title="Just Browsing">
            ...
            <LinkArrow label="About Livepeer" href="/v2/es/home/about/vision" description="Learn what Livepeer is and how it can benefit you." newline={false} />
            <LinkArrow label="Trending at Livepeer" href="/v2/es/community/community/trending-topics" description="See what's new across the Livepeer blog, forum, and socials." newline={false} />
    </DisplayCard>

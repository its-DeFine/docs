...
<Columns cols={2}>
    ...
    <DisplayCard icon="eyes" title="Just Browsing">
            <LinkArrow label="Livepeer Showcase" href="/v2/pages/00_home/project-showcase/showcase" newline={false}  description="Check out real-world projects and get inspired." />
            <LinkArrow label="About Livepeer" href="/v2/pages/00_home/introduction/" description="Learn what Livepeer is and how it can benefit you." newline={false} />
...
- [Livepeer Showcase](/v2/pages/00_home/project-showcase/showcase) - Check out real-world projects and get inspired.

...
<Columns cols={2}>
    ...
    <DisplayCard icon="eyes" title="Just Browsing">
            ...
            <LinkArrow label="About Livepeer" href="../../home/introduction" description="Learn what Livepeer is and how it can benefit you." newline={false} />
    ...
    <DisplayCard icon="camera-movie" title="Real-time AI Video">
        ...
        <LinkArrow label="Daydream" href="../../platforms/products/daydream/overview" newline={false} description="Real-time AI video creation." />
        <LinkArrow label="Livepeer Studio" description="Try out Livepeer Studio, a hosted video platform." newline={false} href="../../platforms/products/livepeer-studio/overview" />
    </DisplayCard>
...
- [Daydream](../../developers/developer-platforms/daydream/daydream.mdx) - Learn more about Daydream, Livepeer's real-time AI video platform.
...
<Columns cols={2}>
    ...
    <DisplayCard icon="server" title="Earn from Idle GPU">
        <LinkArrow label="Orchestrators" href="../../orchestrators/quickstart" newline={false} description="Learn more about running an orchestrator." />
    </DisplayCard>

...
- [Livepeer AI Quickstart](/v2/pages/03_developers/building-on-livepeer/quick-starts/livepeer-ai) - Get started with Livepeer AI in minutes.
...
- [Stream Video Quickstart](/v2/pages/03_developers/building-on-livepeer/quick-starts/video-streaming) - Get started with Livepeer video streaming in minutes.
...
<Columns cols={2}>
    ...
    <DisplayCard icon="wand-magic-sparkles" title="Integrate Video or AI">
        <LinkArrow label="Livepeer AI Quickstart" href="/v2/pages/03_developers/building-on-livepeer/quick-starts/livepeer-ai" newline={false} description="Get started with Livepeer AI in minutes." />
...
<Columns cols={2}>
    ...
    <DisplayCard icon="video" title="Stream or Broadcast">
        <LinkArrow label="Daydream" href="../../platforms/products/daydream/daydream" newline={false} description="Learn more about Daydream, Livepeer's real-time AI video platform." />
        <LinkArrow label="Stream Video Quickstart" href="/v2/pages/03_developers/building-on-livepeer/quick-starts/video-streaming" newline={false} description="Get started with Livepeer video streaming in minutes." />

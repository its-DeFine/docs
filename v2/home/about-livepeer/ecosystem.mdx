...
With this in mind, Livepeer is dedicated beyond to open, accessible architecture but also to a *contributive organisational structure* that optimises for the right people, with the right incentives, working on the right things.
 ...
 **On-Chain Treasury**
 {/* Formed in 2022, the on-chain treasury is issued with 10% of Livepeer block rewards to fund the long-term growth and sustainability of the network. */}
    - In 2022, Livepeer launched the [On-Chain Treasury](/v2/delegators/treasury/overview) to fund the long-term growth and sustainability of the network.

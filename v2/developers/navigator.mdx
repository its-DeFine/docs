...
<AccordionGroup>
  <Accordion title="Call AI inference from my application" icon="bolt">
    ...
    **Path: AI Gateway API via Studio**
    ...
    <LinkArrow href="/v2/developers/resources/reference/apis" label="AI Quickstart -- first call in 10 minutes" />
  ...
  <Accordion title="Build real-time AI video (live webcam or stream effects)" icon="video">
    ...
    **Path: ComfyStream**
    ...
    <LinkArrow href="/v2/developers/build/workload-fit" label="ComfyStream Quickstart" />
  ...
  <Accordion title="Deploy a custom AI model or container" icon="box">
    ...
    **Path: BYOC (Bring Your Own Container)**
    ...
    <LinkArrow href="/v2/developers/build/workload-fit" label="BYOC Guide" />
  ...
  <Accordion title="Integrate video transcoding or streaming" icon="film">
    ...
    **Path: Studio API -- Video**
    ...
    <LinkArrow href="/v2/developers/resources/reference/apis" label="Transcoding Quickstart" />
  ...
  <Accordion title="Contribute to the Livepeer protocol codebase" icon="code">
    ...
    **Path: OSS Contribution**
    ...
    <LinkArrow href="/v2/developers/guides/local-testnet-deployment" label="Contributor Quickstart" />
  ...
  <Accordion title="Evaluate Livepeer for my use case" icon="magnifying-glass">
    ...
    **Path: Evaluation**
    ...
    <LinkArrow href="/v2/developers/concepts/role" label="Developer Stack" /> then <LinkArrow href="/v2/developers/build/workload-fit" label="Workload Fit" newline={false} />
...
<CardGroup cols={3}>
  <Card title="Concepts" icon="lightbulb" href="/v2/developers/concepts/role">

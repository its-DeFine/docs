...
The live interactive reference for the AI API is mounted in the Gateways tab documentation at `/v2/gateways/resources/technical/api-reference/AI-API/ai`.
...
<CardGroup cols={2}>
  <Card title="SDKs" icon="code" href="/v2/developers/resources/sdks">

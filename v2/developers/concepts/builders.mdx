...
For the official SDK and API reference, see <LinkArrow href="/v2/developers/resources/reference/apis" label="Developer resources" newline={false} />. For contribution paths and funded work, see <LinkArrow href="/v2/developers/guides/opportunities/overview" label="Builder opportunities" newline={false} />.
...
See <LinkArrow href="/v2/developers/build/byoc" label="Custom AI pipelines" newline={false} /> for BYOC integration guides.
...
See <LinkArrow href="/v2/developers/guides/beta-projects/naap" label="NaaP guide" newline={false} /> for the full overview.
...
See <LinkArrow href="/v2/developers/guides/beta-projects/pymthouse" label="pymthouse guide" newline={false} /> for the full overview.
...
<CardGroup cols={3}>
  <Card title="NaaP" icon="grid-2" href="/v2/developers/guides/beta-projects/naap" arrow horizontal>
    Build and publish plugins for the official Livepeer network portal.
  </Card>
  <Card title="pymthouse" icon="shield-check" href="/v2/developers/guides/beta-projects/pymthouse" arrow horizontal>

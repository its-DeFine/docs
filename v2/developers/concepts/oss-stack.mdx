---
title: The Livepeer Engineering Stack
sidebarTitle: Architecture Overview
description: The key repositories, components, and layers that make up the Livepeer open source stack, and how they connect.

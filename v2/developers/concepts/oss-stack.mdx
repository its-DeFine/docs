...
description: >-
  Maps the main Livepeer open-source repositories — go-livepeer, livepeer-protocol, ai-worker, comfystream, and
  livepeer.js — and explains how they connect, for developers wanting to contribute.
...
For the full picture on current opportunities, open roles within SPEs, and how to get involved, see [OSS Opportunities](/v2/developers/guides/opportunities/oss-contributions).
...
<CardGroup cols={3}>
  ...
  <Card title="OSS Opportunities" icon="hand-holding-heart" href="/v2/developers/guides/opportunities/oss-contributions">

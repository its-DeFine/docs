...
description: >-
  Explains the relationship between Studio, Daydream, the AI gateway API, ComfyStream, and the raw Livepeer protocol —
  so you can choose the right layer to build at.
...
<StyledTable variant="bordered">
  ...
  <tbody>
    <TableRow>
      ...
      <TableCell>-</TableCell>
      <TableCell>[AI quickstart](/v2/developers/get-started/ai-quickstart)</TableCell>
    </TableRow>
    <TableRow>
...
<CardGroup cols={3}>
  ...
  <Card title="NaaP plugin development" icon="grid-2" href="/v2/developers/guides/beta-projects/naap" arrow horizontal>
    Build and publish a plugin for the official Livepeer Network portal.
  </Card>
  <Card title="Ecosystem projects" icon="telescope" href="/v2/developers/concepts/builders" arrow horizontal>

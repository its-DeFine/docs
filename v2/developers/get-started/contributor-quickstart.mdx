...
description: >-
  Get the Livepeer protocol running locally, set up a testnet with one orchestrator and one gateway, and submit your
  first test job.
...
<StyledSteps iconColor="var(--lp-color-accent)" titleColor="var(--accent)">
  ...
  <StyledStep title="Deploy testnet contracts" icon="file-contract">
    ...
    For a full walkthrough of contract deployment options, see the <a href="/v2/developers/guides/local-testnet-deployment">local testnet deployment guide</a>.
  </StyledStep>
...
<CardGroup cols={2}>
  ...
  <Card title="OSS Contributions" icon="people-group" href="/v2/developers/guides/opportunities/oss-contributions">

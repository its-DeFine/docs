...
description: >-
  Four quickstart tracks for building on Livepeer: AI inference, real-time AI video, video transcoding, and OSS
  contribution.
...
<CardGroup cols={1}>
  <Card title="AI Quickstart" icon="bolt" href="/v2/developers/resources/reference/apis" arrow>
...
<CardGroup cols={1}>
  <Card title="ComfyStream Quickstart" icon="video" href="/v2/developers/build/workload-fit" arrow>
...
<CardGroup cols={1}>
  <Card title="Video API Reference" icon="rectangle-terminal" href="/v2/developers/resources/reference/apis" arrow>
...
<CardGroup cols={1}>
  <Card title="Local Testnet" icon="server" href="/v2/developers/guides/local-testnet-deployment" arrow>
...
<StyledTable variant="bordered">
  ...
  <tbody>
    ...
    <TableRow>
      ...
      <TableCell>BYOC -- see <a href="/v2/developers/build/workload-fit">BYOC Guide</a></TableCell>
    </TableRow>
    <TableRow>

...
<CardGroup cols={3}>
  <Card title="AI Pipelines" icon="diagram-project" href="/v2/developers/concepts/role">
 ComfyStream and BYOC - how to build and deploy inference pipelines.
  </Card>
  <Card title="BYOC" icon="box" href="/v2/developers/build/workload-fit">
 Bring your own container: run custom models on the network.
  </Card>
  <Card title="Model support" icon="microchip-ai" href="/v2/developers/resources/reference/apis">

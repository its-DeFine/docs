...
description: >-
  Integrate Livepeer AI and video APIs via official SDKs in TypeScript, Python, and Go. Covers authentication, error
  handling, retries, and SDK vs direct REST trade-offs.

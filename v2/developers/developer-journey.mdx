...
flowchart TD
    ...
    BYOC --> GW["Run a Gateway"]
    GW --> DEPLOY["Deploy to<br/>Orchestrators"]
...
<Steps>
  ...
  <Step title="Deploy to orchestrators" icon="arrow-up-right-from-square">
    Push your BYOC container to the network through your gateway. Orchestrators pull your container and execute workloads on their GPUs.

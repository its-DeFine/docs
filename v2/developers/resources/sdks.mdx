...
<CardGroup cols={2}>
  <Card title="Livepeer Studio SDKs" icon="video" href="/solutions/livepeer-studio/docs/reference/sdks" arrow>
...
- **Full Documentation**: [Livepeer Studio SDKs](/solutions/livepeer-studio/docs/reference/sdks)

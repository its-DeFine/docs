...
<CardGroup cols={2}>
  ...
  <Card title="SDK Integration Guide" icon="laptop-code" href="/v2/developers/resources/reference/sdks">
    Full examples, error handling, and retry configuration.
  </Card>
  <Card title="AI Authentication" icon="lock" href="/v2/developers/resources/reference/apis">

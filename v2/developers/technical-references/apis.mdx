...
<CardGroup cols={2}>
  <Card title="Livepeer Studio API" icon="video" href="/platforms/livepeer-studio/reference/api" arrow>
...
- **Full Documentation**: [Livepeer Studio API Overview](/platforms/livepeer-studio/reference/api) and [API Reference](/platforms/livepeer-studio/reference/overview)

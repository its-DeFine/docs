...
<CardGroup cols={2}>
  <Card title="Livepeer Studio SDKs" icon="video" href="/platforms/livepeer-studio/reference/sdks" arrow>
...
- **Full Documentation**: [Livepeer Studio SDKs](/platforms/livepeer-studio/reference/sdks)

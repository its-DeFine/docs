...
<Note>
For full BYOC architecture, Gateway/Orchestrator roles, container lifecycle, and Protocol vs AI BYOC concepts, see the [BYOC full guide](../ai-inference-on-livepeer/byoc).
</Note>
...
- [BYOC full guide](../ai-inference-on-livepeer/byoc) — Architecture, Gateway/Orchestrator, container lifecycle
- [Network interfaces](/v2/about/livepeer-network/interfaces)

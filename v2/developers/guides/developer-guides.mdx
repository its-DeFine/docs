...
description: >-
  A curated library of how-to guides, tutorials, and walkthroughs for building with Livepeer — from first API call to
...
<Card title="Video APIs" icon="rectangle-terminal" href="/v2/developers/resources/reference/apis">
 Compare the maintained API surfaces before following a credentialed video workflow.
</Card>

<Card title="Local Testnet" icon="server" href="/v2/developers/guides/local-testnet-deployment">

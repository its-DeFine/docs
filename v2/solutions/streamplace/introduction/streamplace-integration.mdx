...
how developers can integrate Streamplace into their decentralized applications. Streamplace provides a complete **ingest → provenance → transcoding → distribution** pipeline that plugs directly into the Livepeer Network.

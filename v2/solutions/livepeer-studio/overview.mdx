...
<CardGroup cols={2}>
  ...
  <Card title={<CustomCardTitle icon="rectangle-terminal" title="Studio CLI" />} href="/solutions/livepeer-studio/get-started/studio-cli" arrow>
  ...
  <Card title={<CustomCardTitle icon="code" title="API reference" />} href="/solutions/livepeer-studio/reference/api" arrow>

...
- **Low or fluctuating ingest rate** - Check the broadcaster’s upload speed and encoder bitrate/keyframe settings. See [Stream via OBS](stream-via-obs) and [Optimise latency](optimize-latency).

...
The CLI sets up a project that uses your API key and stream for broadcasting or playback. Customize it from there using the [Livestream](/solutions/livepeer-studio/docs/livestream/overview) and [VOD](/solutions/livepeer-studio/docs/video-on-demand/overview) guides and the [SDKs overview](/solutions/livepeer-studio/docs/reference/sdks).

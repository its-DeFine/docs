...
<Info>
  This page is updated automatically via GitHub Action. For help and support join the [Livepeer Discord](https://discord.gg/livepeer).
</Info>
...
<Update label="v0.19.0 — June 2024" description="* api: projects: allUsers param in projects list by @gioelecerati in https://github.com/livepeer/studio/pull/2206" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.19.0", description: "* api: projects: allUsers param in projects list by @gioelecerati in https://github.com/livepeer/studio/pull/2206" }}>
  ## v0.19.0
  ...
  * api: Allow patching a stream recordingSpec
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.19.0)
</Update>

<Update label="v0.18.0 — June 2024" description="* api: access-control: allowedOrigins by @gioelecerati in https://github.com/livepeer/studio/pull/2176" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.18.0", description: "* api: access-control: allowedOrigins by @gioelecerati in https://github.com/livepeer/studio/pull/2176" }}>
  ## v0.18.0
  ...
  * db: index: asset phase, deleted, deletedAt
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.18.0)
</Update>

<Update label="v0.17.0 — May 2024" description="* fix: fix broadcasting by @0xcadams in https://github.com/livepeer/studio/pull/2028" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.17.0", description: "* fix: fix broadcasting by @0xcadams in https://github.com/livepeer/studio/pull/2028" }}>
  ## v0.17.0
  ...
  * refactor: improve api schema
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.17.0)
</Update>

<Update label="v0.16.2 — February 2024" description="* api: Create PUT /stream/pull API for idempotent pull stream by @victorges in https://github.com/livepeer/studio/pul..." tags={["Release"]} rss={{ title: "Livepeer Studio v0.16.2", description: "* api: Create PUT /stream/pull API for idempotent pull stream by @victorges in https://github.com/livepeer/studio/pul..." }}>
  ## v0.16.2

  ## What's Changed
  * api: Create PUT /stream/pull API for idempotent pull stream

  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.16.2)
</Update>

<Update label="v0.16.1 — February 2024" description="* Document the quality param by @leszko in https://github.com/livepeer/studio/pull/1996" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.16.1", description: "* Document the quality param by @leszko in https://github.com/livepeer/studio/pull/1996" }}>
  ## v0.16.1
  ...
  * @denbrkic made their first contribution in https://github.com/livepeer/studio/pull/2023
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.16.1)
</Update>

<Update label="v0.16.0 — December 2023" description="* Add Quality param to profile by @leszko in https://github.com/livepeer/studio/pull/1880" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.16.0", description: "* Add Quality param to profile by @leszko in https://github.com/livepeer/studio/pull/1880" }}>
  ## v0.16.0
  ...
  * db: cache objects with ttl
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.16.0)
</Update>

<Update label="v0.15.7 — December 2023" description="* Handle update task failure by @mjh1 in https://github.com/livepeer/studio/pull/1983" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.15.7", description: "* Handle update task failure by @mjh1 in https://github.com/livepeer/studio/pull/1983" }}>
  ## v0.15.7
  ...
  * access-control: admin public key access
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.15.7)
</Update>

<Update label="v0.15.6 — November 2023" description="* api: have tus respect X-Forwarded-Proto headers by @iameli in https://github.com/livepeer/studio/pull/1874" tags={["Features", "Fixes"]} rss={{ title: "Livepeer Studio v0.15.6", description: "* api: have tus respect X-Forwarded-Proto headers by @iameli in https://github.com/livepeer/studio/pull/1874" }}>
  ## v0.15.6
  ...
  * api: asset: rerun tasks
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.15.6)
</Update>

<Update label="v0.15.5 — September 2023" description="* billing: hackers with pay as you go by @gioelecerati in https://github.com/livepeer/studio/pull/1867" tags={["Fixes"]} rss={{ title: "Livepeer Studio v0.15.5", description: "* billing: hackers with pay as you go by @gioelecerati in https://github.com/livepeer/studio/pull/1867" }}>
  ## v0.15.5
  ...
  * www: gitignore sitemap
  ...
  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.15.5)
</Update>

<Update label="v0.15.4 — September 2023" description="* chore: bump @livepeer/react@^2.8.2 by @iameli in https://github.com/livepeer/studio/pull/1864" tags={["Release"]} rss={{ title: "Livepeer Studio v0.15.4", description: "* chore: bump @livepeer/react@^2.8.2 by @iameli in https://github.com/livepeer/studio/pull/1864" }}>
  ## v0.15.4

  ## What's Changed
  * chore: bump @livepeer/react@^2.8.2

  [View release on GitHub](https://github.com/livepeer/studio/releases/tag/v0.15.4)
</Update>

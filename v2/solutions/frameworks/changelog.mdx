...
<Update label="v0.2.0-rc3" tags={["Release"]} rss={{ title: "Frameworks v0.2.0-rc3", description: "Full Changelog: https://github.com/Livepeer-FrameWorks/monorepo/compare/v0.2.0-rc2...v0.2.0-rc3" }} description={<div style={{fontSize: "0.8rem", fontWeight: 700, color: "var(--hero-text)"}}>March 2026</div>}>
  ## v0.2.0-rc3

...
- `classification: moderate` — Meaningful friction/confusion with limited scope or workaround
...
All significant changes are documented in the [Changelog](/v2/resources/changelog/changelog).

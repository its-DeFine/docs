...
<TabsContainer>
    ...
    <Frame caption="">
        <iframe height="200px" width="100%" frameborder="no" scrolling="no" seamless src="https://player.simplecast.com/f6d42d55-3e7d-4d92-8517-8d84c18386af?dark=true"/>
    </Frame>
    ...
    {/* The ["Get AI to Set Up the Gateway"](v2/gateways/run-a-gateway/quickstart/get-AI-to-setup-the-gateway.mdx) page is a direct instantiation of this principle: a page written for AI agent consumption, not human browsing.  */}

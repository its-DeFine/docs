...
<TabsContainer>
    ...
    {/* The ["Get AI to Set Up the Gateway"](/v2/gateways/run-a-gateway/quickstart/get-AI-to-setup-the-gateway) page is a direct instantiation of this principle: a page written for AI agent consumption, not human browsing.  */}

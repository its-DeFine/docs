...
sidebarTitle: Aims
description: "This page articulates the philosophical framework that underpinned the v2 engagement and demonstrates how the RFP's three overarching themes for **stakeholder-focused**, **AI-first**, and **future-proofed** documentation, were delivered across every layer of the system."
keywords: ["livepeer", "internal", "rfp", "aims", "documentation philosophy", "rfp aim delivery"]
...
<TabsContainer>
    <Tab title="AI-first" icon="user-robot">
        ...
        - **"Get AI to Set Up the Gateway"** — Novel documentation pattern (v2/pages/04_gateways/run-a-gateway/quickstart/get-AI-to-setup-the-gateway.mdx) written for AI agent execution with explicit preconditions, step invariants, and verification criteria.
        ...
        - **Repository AI Guidance** — .github/AGENTS.md and .cursorrules ensure AI coding tools operate within repository conventions.

        - **Machine-Readable Architecture Maps** — docs-guide/feature-map.mdx and docs-guide/architecture-map.mdx provide Mermaid diagrams for AI understanding of system structure.
        ...
        - **[Technical]** Repository AI guidance files (AGENTS.md, .cursorrules) make the documentation repository itself legible to AI coding assistants — enabling developers using AI tools to query and navigate the docs repo without human instruction.
        ...
        - **"Get AI to Set Up the Gateway"** — Dedicated quickstart (v2/pages/04_gateways/run-a-gateway/quickstart/get-AI-to-setup-the-gateway.mdx) written as a structured prompt for AI agent consumption. Developers copy and paste the prompt into their AI assistant to set up a Livepeer gateway. Establishes a "copy to AI" quickstart pattern extendable across the library.
        ...
        - **AGENTS.md & .cursorrules** — System-level context for AI coding tools. Provides repository structure, naming conventions, and governance rules automatically—improving AI consumer accuracy without human onboarding.
    ...
    <Tab title="Future-proofed" icon="space-station-moon-construction">
        ...
        - **[Internal docs]** docs-guide/ internal operating system: README.md (source-of-truth model, update rules), feature-map.md (8 feature areas), architecture-map.md (data/control flow with Mermaid diagram), lpd.md (CLI operator runbooks), quality-gates.md (local/CI enforcement matrix), automation-pipelines.md (all automation surfaces), content-system.md (IA model, copy principles), data-integrations.md (API specs, external feeds). Three generated indexes: scripts-index.md, workflows-index.md, templates-index.md — all auto-updated when contents change.
        ...
        - **[Scripts]** Script self-documentation enforcement: every script must have a header (summary, usage, owner). Script index (scripts-index.md) is auto-generated. New scripts created via new-script.js template are pre-filled with the required schema. The documentation system documents itself.
        ...
        - **[Scripts]** docs-usefulness-accuracy-verifier.test.js (tests/unit/) validates source-weighted accuracy verification rules: GitHub vs. DeepWiki precedence, freshness signals, fallback behaviour, and cache reuse. As of the February 2026 audit run, 384 pages were scored across human usefulness and agent usefulness dimensions — producing a cohort breakdown by section (about: avg 62.8 human/64.0 agent; lpt: 61.5/56.8; platforms: 52.7/52.9). This automated accuracy scoring system is a novel feature of the v2 infrastructure with no equivalent in v1.
        ...
        - **[Scripts]** Script self-documentation enforcement (tests/unit/script-docs.test.js): every script in the repository must carry a structured header (summary, usage, owner). The test enforces this schema on commit and CI. new-script.js scaffolds new scripts with the required header pre-filled. The result: the 58-script library documents itself. Any maintainer — human or AI — can read scripts-index.md (auto-generated from the headers) to understand every automation in the system.
        ...
        - **[Technical]** The Mermaid data/control flow diagram in docs-guide/architecture-map.mdx is maintained manually but provides a machine-readable (and AI-parseable) system overview. Any AI tool querying the repository can read this diagram to understand the full execution architecture without human explanation.
    ...
    <Tab title="Stakeholder-focused" icon="people-group">
        ...
        - **[Internal docs]** docs-guide/content-system.mdx codifies the IA model, content layers, and copy principles so any future maintainer can understand the stakeholder-driven design rationale.

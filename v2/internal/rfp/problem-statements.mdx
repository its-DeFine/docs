...
<AccordionGroup>
    ...
    <Accordion title="Implementation">
        ...
        - **[Internal docs]** docs-guide/data-integrations.md documents all API specifications, external feeds, and internal data layers — providing a single reference for maintainers to understand what data sources exist and how they are kept current.

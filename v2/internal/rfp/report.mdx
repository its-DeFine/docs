...
<StyledTable variant="bordered">
  <thead>
    <tr style={{ backgroundColor: "var(--accent)", color: "var(--lp-color-on-accent)" }}>
      <th style={{ padding: "12px 16px", fontWeight: "600", color: "var(--lp-color-on-accent)" }}>Deliverable</th>
      <th style={{ padding: "12px 16px", fontWeight: "600", color: "var(--lp-color-on-accent)" }}>Status</th>
      <th style={{ padding: "12px 16px", fontWeight: "600", color: "var(--lp-color-on-accent)" }}>Notes</th>
      <th style={{ padding: "12px 16px", fontWeight: "600", color: "var(--lp-color-on-accent)" }}>Details</th>
    </tr>
  </thead>
  <tbody>
    {/* (i) Present Documentation Strategy */}
    <tr style={{ backgroundColor: "var(--accent)", color: "var(--lp-color-on-accent)" }}>
      <td colSpan="4" style={{ padding: "10px 16px", fontWeight: "700", color: "var(--lp-color-on-accent)" }}>(i) Present Documentation Strategy</td>
    </tr>
    ...
    <tr style={{ backgroundColor: "var(--accent)", color: "var(--lp-color-on-accent)" }}>
      <td colSpan="4" style={{ padding: "10px 16px", fontWeight: "700", color: "var(--lp-color-on-accent)" }}>(ii) Re-Write Documentation</td>
    </tr>
    <tr style={{ backgroundColor: "var(--card-background)" }}>
    ...
    <tr style={{ backgroundColor: "var(--accent)", color: "var(--lp-color-on-accent)" }}>
      <td colSpan="4" style={{ padding: "10px 16px", fontWeight: "700", color: "var(--lp-color-on-accent)" }}>(iii) V1 Documentation Live</td>
    </tr>
    <tr style={{ backgroundColor: "var(--card-background)" }}>
    ...
    <tr style={{ backgroundColor: "var(--accent)", color: "var(--lp-color-on-accent)" }}>
      <td colSpan="4" style={{ padding: "10px 16px", fontWeight: "700", color: "var(--lp-color-on-accent)" }}>(iv) Public Workflow for Maintenance and Community Contributions</td>
    </tr>
    <tr style={{ backgroundColor: "var(--card-background)" }}>

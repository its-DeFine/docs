...
Runbooks documented in `docs-guide/lpd.md` cover first-time setup, local docs development, test entrypoints, hook management, and script discovery. The CLI includes a `.lpdignore` pattern system for excluding scripts from discovery.
...
**Source-of-truth policy.** A documented and enforced source-of-truth policy (`docs-guide/source-of-truth-policy.md`) defines canonical ownership boundaries across README, docs-guide, tests, and Mintlify pages — preventing documentation drift. The policy is enforced via `tests/unit/docs-guide-sot.test.js` and `tools/scripts/generate-docs-guide-indexes.js --check`.
...
| File                                 | Contents                                                              |
| ------------------------------------ | --------------------------------------------------------------------- |
| `docs-guide/README.md`               | Source-of-truth model, start-here index, update rules                 |
| `docs-guide/feature-map.md`          | Complete repository capability map across 8 feature areas             |
| `docs-guide/architecture-map.md`     | Data and control flow, execution layers, key contract edges           |
| `docs-guide/lpd.md`                  | CLI behavior, operator runbooks for all command groups                |
| `docs-guide/quality-gates.md`        | Full matrix of local and CI enforcement with blocking/advisory status |
| `docs-guide/automation-pipelines.md` | All automation surfaces, pipeline coverage, operational controls      |
| `docs-guide/content-system.md`       | IA model, content layers, copy and quality principles                 |
| `docs-guide/data-integrations.md`    | API specifications, external feeds, internal data layers              |
...
The source-of-truth policy enforced through `docs-guide/source-of-truth-policy.md` defines canonical ownership boundaries and change management rules — ensuring that as the documentation system evolves, it does so without introducing drift or duplication.
...
| #   | Work item                                   | Description                                                  | Low hrs | High hrs | Actuals |
| --- | ------------------------------------------- | ------------------------------------------------------------ | ------- | -------- | ------- |
| D1  | `docs-guide/README.md`                      | Source-of-truth model, index, update rules                   | 2       | 4        | \_\_    |
| D2  | `docs-guide/feature-map.md`                 | Complete 8-area capability map                               | 3       | 5        | \_\_    |
| D3  | `docs-guide/architecture-map.md`            | Data flow, execution layers, contract edges, Mermaid diagram | 3       | 5        | \_\_    |
| D4  | `docs-guide/lpd.md`                         | CLI behaviour and operator runbooks for all command groups   | 4       | 7        | \_\_    |
| D5  | `docs-guide/quality-gates.md`               | Gate matrix — local, PR, browser; blocking vs advisory       | 3       | 5        | \_\_    |
| D6  | `docs-guide/automation-pipelines.md`        | All automation surfaces and pipeline coverage                | 3       | 5        | \_\_    |
| D7  | `docs-guide/content-system.md`              | IA model, content layers, copy principles                    | 2       | 4        | \_\_    |
| D8  | `docs-guide/data-integrations.md`           | API specs, external feeds, internal data layers              | 2       | 4        | \_\_    |
| D9  | `docs-guide/source-of-truth-policy.md`      | Canonical ownership boundaries and change management rules   | 3       | 5        | \_\_    |
...
| ------------------------------------- | ------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------- |
| `lpd` CLI                             | Back-end ops        | Unified maintainer CLI for all repo operations (setup, dev, test, hooks, scripts)             | `lpd`, `docs-guide/lpd.md`                                                                   | Large (20–30 hrs)           |
...
| Source-of-truth policy                | Governance          | Canonical ownership boundaries, change management rules, enforced via CI                      | `docs-guide/source-of-truth-policy.md`; `tests/unit/docs-guide-sot.test.js`                  | Small                       |

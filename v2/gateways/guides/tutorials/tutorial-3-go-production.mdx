...
<Tip>
You can also fund your gateway using `cast send` directly to the Livepeer `TicketBroker` contract on Arbitrum One. The contract address is in the [Contract Addresses reference](/v2/about/resources/livepeer-contract-addresses). This is useful for scripting gateway fund management in CI/CD pipelines.
</Tip>

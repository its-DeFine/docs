...
description: >-
  Network-as-a-Platform model - multi-tenant Gateway architecture, API key management, billing integration, tenant
  isolation, and building a platform business on Livepeer.

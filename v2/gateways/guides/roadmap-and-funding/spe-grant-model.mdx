...
description: >-
  How Gateway operators access Livepeer treasury funding through the Special Purpose
  Entity (SPE) grant model - what SPEs are, what has been funded, and how to propose
  one.
PageType: guide
audience: gateway
purpose: operate

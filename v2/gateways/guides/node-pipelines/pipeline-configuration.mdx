...
<BorderedBox variant="accent">
    <Tabs>
        ...
        <Tab title="AI" icon="user-robot">
            ...
            <Note>
 For AI routing architecture and orchestrator discovery, see <LinkArrow href="/v2/gateways/guides/node-pipelines/ai-pipelines" label="AI Pipelines" newline={false} />. This section explains the tuning parameters you adjust after your AI gateway is running.
            </Note>

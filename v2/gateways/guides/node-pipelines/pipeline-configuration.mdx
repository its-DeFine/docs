...
description: >-
  Post-setup tuning for Livepeer gateway pipelines - video transcoding profiles (JSON encoding ladder, presets, recipes)
  and AI inference tuning (retry timeouts, model selection, warm vs cold behaviour).
...
- Dual gateway resource allocation covered in setup/configure.mdx and advanced-operations/scaling.mdx

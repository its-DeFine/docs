...
description: >-
  How AI inference jobs flow through your gateway - HTTP request routing, orchestrator discovery via -orchAddr,
  capability and model matching via AISessionManager, retry logic, available pipeline types (Standard API, ComfyStream,
  BYOC), and platform limitations.
...
<CardGroup cols={2}>
  ...
  <Card title="AI API Reference" icon="code" href="/v2/gateways/resources/reference/technical/api-reference/AI-API/text-to-image">

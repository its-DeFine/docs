...
sidebarTitle: BYOC
description: >-
  Run custom AI models on Livepeer orchestrators via BYOC: architecture, implementation
  patterns, hard constraints, and step-by-step setup.
PageType: resource
audience: developer
purpose: orient
status: current
...
Contract and ABI references: [Contract Addresses](/v2/about/resources/reference/livepeer-contract-addresses)

...
description: >-
  Run Ethereum payment signing as a separate service. Isolates the private key from the gateway process, enables keyless
  Live AI gateways, and provides the technical primitive for clearinghouse infrastructure.

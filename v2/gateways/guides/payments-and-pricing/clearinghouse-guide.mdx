...
description: >-
  How third-party clearinghouses manage ETH custody, PM signing, and orchestrator
  settlement on behalf of gateway operators. Covers architecture, developer setup,
  building a clearinghouse, and current status.
PageType: guide
audience: gateway
purpose: operate
status: current

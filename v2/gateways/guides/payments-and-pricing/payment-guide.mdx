...
description: >-
  Choose the right payment path for a Livepeer gateway. Covers on-chain self-managed,
  remote signer, and clearinghouse options by operational mode and node type.
PageType: guide
audience: gateway
purpose: orient
status: current

...
<Tabs>
    ...
    <Tab title="On-Chain" icon="link">
        <BorderedBox variant="accent">
            ...
            - All Contract Adresses <LinkArrow href="/v2/about/resources/livepeer-contract-addresses" label="Livepeer Contract Addresses" />
            ...
            <br/>For Livepeer contract addresses, see <LinkArrow href="/v2/about/resources/livepeer-contract-addresses" label="Contract Addresses" newline={false} />.
        </BorderedBox>
    </Tab>
</Tabs>

...
For the current TicketBroker address, see <LinkArrow href="/v2/about/resources/livepeer-contract-addresses" label="Contract Addresses" newline={false} />.
...
<CardGroup cols={3}>
  <Card title="Contract Addresses" icon="file-contract" href="/v2/about/resources/livepeer-contract-addresses">

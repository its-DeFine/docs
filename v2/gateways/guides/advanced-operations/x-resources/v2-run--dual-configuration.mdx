...
<table style={{ width: '100%', borderCollapse: 'collapse' }}>
  <thead>
    <tr style={{ background: "var(--lp-color-bg-card)", borderBottom: '2px solid #2d9a67' }}>
      <th
        style={{
          padding: '12px 16px',
          textAlign: 'left',
 ...
 AI Pipelines
  ...
  <tbody>
    <tr style={{ borderBottom: '1px solid #333' }}>
      <td style={{ padding: '10px 16px', color: "var(--lp-color-accent)" }}>
 Processing Type
      </td>
 ...
 AISessionManager
    ...
    <tr style={{ borderBottom: '1px solid #333' }}>
 <td style={{ padding: '10px 16px', color: "var(--lp-color-accent)" }}>Payment Model</td>
 <td style={{ padding: '10px 16px' }}>Per segment</td>
 <td style={{ padding: '10px 16px' }}>Per pixel processed</td>
    </tr>
    <tr style={{ borderBottom: '1px solid #333' }}>
 <td style={{ padding: '10px 16px', color: "var(--lp-color-accent)" }}>Protocol</td>
 ...
 Trickle protocol for real-time AI
    ...
    <tr style={{ borderBottom: '1px solid #333' }}>
 <td style={{ padding: '10px 16px', color: "var(--lp-color-accent)" }}>Components</td>
...
<table style={{ width: '100%', borderCollapse: 'collapse' }}>
 ...
 Flag
      ...
      <th style={{ padding: '12px 16px', textAlign: 'left', color: "var(--lp-color-on-accent)" }}>
 Description
      </th>
      <th style={{ padding: '12px 16px', textAlign: 'center', color: "var(--lp-color-on-accent)" }}>
 Required
      </th>
    </tr>
  </thead>

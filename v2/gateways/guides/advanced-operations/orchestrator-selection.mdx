...
description: >-
  Choose the best Orchestrators for Gateway workloads - selection criteria, performance scoring, capability-based
  routing, blocklists, and failover strategies.
...
<br/> For production workloads, operators often need more control. Manual selection, quality tiering, and failover configuration.
...
<CardGroup cols={2}>
  ...
  <Card title="Orchestrator Offerings" icon="book" href="/v2/gateways/resources/reference/technical/orchestrator-offerings">

...
<FlexContainer direction="column" align="center" style={{margin: '0 auto'}}>
  <Callout icon="party-horn" color="var(--lp-color-accent)">
...
how Gateways can discover and offer Orchestrator Services,
...
This is crucial for the growth of Livepeer’s decentralised AI compute economy.

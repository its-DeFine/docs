...
<Columns cols={2}>
  <Card
    ...
    icon="film-canister"
    href="/v2/gateways/setup/configure/video-configuration"
    arrow
  >
 Configure video transcoding services
  ...
  <Card
    ...
    icon="user-robot"
    href="/v2/gateways/setup/configure/ai-configuration"
    arrow
  >
 Configure AI inference services
  ...
  <Card
    ...
    icon="drone"
    href="/v2/gateways/setup/configure/dual-configuration"
    arrow
  >
 Configure both video transcoding and AI inference services
  ...
  <Card
    ...
    href="/v2/gateways/setup/configure/pricing-configuration"
    arrow
  >

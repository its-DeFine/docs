...
<Card
  ...
  title="Next Step"
  arrow
  href="/v2/gateways/setup/requirements/on-chain%20setup/fund-gateway"
>
 {' '}
 Fund Your Gateway{' '}
</Card>
...
<StyledStep title="Funding Your Gateway">
    <Card title="Funding Your Gateway" href="/v2/gateways/setup/requirements/on-chain%20setup/fund-gateway" icon="piggy-bank" horizontal arrow >
 ...
 **Windows**
 ...
 See <DoubleIconLink label="Fund Your Gateway" href="/v2/gateways/setup/requirements/on-chain%20setup/fund-gateway" iconLeft="coins" />

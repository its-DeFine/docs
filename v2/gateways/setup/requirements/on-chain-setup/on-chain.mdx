...
description: >-
  This page will take you through setting up the additional requirements for running a
  Gateway in On-Chain mode including finding an RPC URL, and creating an Ethereum
  account and keystore.
PageType: guide
audience: gateway
purpose: operate
status: current
...
<Columns cols={3}>
 ...
 Related Pages
        ...
        - [Fund Gateway](/v2/gateways/guides/payments-and-pricing/fund-gateway)
        - [Install Gateway](/v2/gateways/setup/install)
        - [RPC Reference](/v2/gateways/resources/compendium/arbitrum-rpc)
    </div>
...
In order to interact with the [Livepeer smart contracts](/v2/about/resources/reference/livepeer-contract-addresses) you will need to connect to an Arbitrum RPC.
...
>
 ...
 Livepeer will automatically create a new wallet & keystore for you if you do not provide an existing wallet address after first [installing your Gateway software](/v2/gateways/setup/install).
...
<StyledStep title="RPC URL `-ethUrl` flag" titleSize="h2">
 ...
 Chainlist provides a full list of public Arbitrum One RPCs (including the Arbitrum public RPC):
            ...
            - Dynamically Imported: <DoubleIconLink label="Arbitrum RPC Reference" href="/v2/gateways/resources/compendium/arbitrum-rpc" iconLeft="books" />
...
<StyledStep title="ETH Keystore `-ethKeystorePath`" titleSize="h2">
 ...
 Create a keystore file using Livepeer devtools or Ethereum tooling.
    ...
    <Tip>
 It's recommended to let Livepeer devtools automatically create the keystore on first run after [installing the Gateway software](/v2/gateways/setup/install).
    </Tip>
...
<StyledStep title="Funding Your Gateway">
    <Card title="Funding Your Gateway" href="/v2/gateways/guides/payments-and-pricing/fund-gateway" icon="piggy-bank" horizontal arrow >
 ...
 **Windows**
 ...
 See <DoubleIconLink label="Fund Your Gateway" href="/v2/gateways/guides/payments-and-pricing/fund-gateway" iconLeft="coins" />

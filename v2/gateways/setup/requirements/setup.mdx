...
description: >-
  Learn about the hardware, network, and software requirements for running a Livepeer
  Gateway.
PageType: guide
audience: gateway
purpose: operate
...
<StyledSteps
  iconColor="var(--lp-color-accent-strong)"
  titleColor="var(--lp-color-on-accent)"
  lineColor="var(--lp-color-accent-strong)"
  iconSize="24px"
>
  ...
  <Step title="Additional Requirements" icon="user-robot" titleSize="h3">
    ...
    <Tabs>
      ...
      <Tab title="On-Chain Gateways" icon="link">
        ...
        <Card title="Go to On-Chain Setup Guide" icon="chain" href="/v2/gateways/setup/requirements/on-chain-setup/on-chain" horizontal arrow>

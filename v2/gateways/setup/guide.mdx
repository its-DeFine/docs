...
sidebarTitle: Guide
description: >-
  Connect Applications with Video & AI services by running your own Gateway! This page gives an overview of the steps to
  run a Gateway node.
...
<Columns cols={2}>
    <Card
        ...
        href="/v2/gateways/guides/deployment-details/setup-options"
        horizontal
        arrow
        >
    ...
    <Card
        ...
        href="/v2/gateways/guides/tutorials/tutorials-resources"
        horizontal
        arrow
        >
    ...
    <Card
        ...
        href="/v2/gateways/guides/node-pipelines/ai-pipelines"
        horizontal
        arrow
        >

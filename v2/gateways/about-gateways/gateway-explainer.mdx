...
keywords: ["livepeer", "gateways", "about gateways", "gateway explainer", "gateway", "explainer"]
...
Hosted services like [Daydream](../../developers/developer-platforms/daydream/daydream.mdx) operate as both application layers and Gateways.
...
Anyone that wants to build applications and services (like [Daydream](../../developers/developer-platforms/daydream/daydream.mdx) and [Stream.place](../../platforms/streamplace/overview.mdx)) on top of the Livepeer

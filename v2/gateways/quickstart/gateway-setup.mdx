...
<Columns cols={2}>
 ...
 See Prerequisites & Requirements.{' '}
  ...
  <Card title="On-Chain Setup" href="/v2/gateways/setup/requirements/on-chain%20setup/on-chain" arrow horizontal>
 See on-chain Setup Checklist.
  </Card>
  <Card title="Run a Gateway" href="/v2/gateways/setup/run-a-gateway" arrow horizontal>

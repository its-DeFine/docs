...
description: >-
  Get a Livepeer dual AI / video Gateway node up and running locally or on the Livepeer
  network.
...
import { latestReleasePageUrl, latestVersion } from '/snippets/data/globals/latestRelease.jsx';
...
<TipWithArrow>
 <Subtitle style={{fontSize: '1.0rem'}}> Use the <Icon icon="circle-chevron-down" /> **Dropdown** at the top-right of this page to view the Quickstart Guide
...
<Note>
 <Subtitle style={{fontSize: '1.0rem'}}><Icon icon="docker" size={20}/> [Docker](https://docs.docker.com/get-docker/) is the recommended way to install and run a Livepeer Gateway Node.</Subtitle>
  <br/>
 <br/><Subtitle style={{fontSize: '1.0rem'}}><Icon icon="linux" size={20}/> [Linux OS](https://linux.org) is recommended for production use.</Subtitle>
</Note>
...
<View title=" Docker" icon="docker" iconType="solid">
 ...
 {/* MOVE TO OWN PAGE*/}
  <Columns cols={2}>
    <Card
      ...
      href="/v2/gateways/setup/install/docker-install"
      arrow
      horizontal
    >
 View Full Installation Guide
    ...
    <Card
      ...
      href="../resources/reference/technical/configuration-flags"
      arrow
      horizontal
    >
 ...
 _**Choose your Gateway Mode:**_
  <Tabs>
      <LinuxOffChainTab
        ...
        latestReleasePageUrl={latestReleasePageUrl}
        GatewayOffChainWarning={GatewayOffChainWarning}
 ...
 {/* MOVE TO OWN PAGE*/}
  <Columns cols={2}>
    <Card
      ...
      href="/v2/gateways/setup/install/linux-install"
      arrow
      horizontal
    >
 View Full Installation Guide
...
<View title="Windows" icon="windows" iconType="solid">
  ...
  <Columns cols={2}>
    <Card
      ...
      href="/v2/gateways/setup/install/windows-install"
      arrow
      horizontal
    >
 View Full Installation Guide
...
It uses defaults for all optional parameters. See the [full setup guide](/v2/gateways/setup/guide) for more details on customising your Gateway. \*/}

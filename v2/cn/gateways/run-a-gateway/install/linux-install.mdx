---
title: Linux 安装
description: 如何从源二进制文件安装一个 Livepeer Gateway
sidebarTitle: Linux 安装
icon: linux
keywords:
  - livepeer
  - gateways
...
---
{/* codex-i18n:  */}
...
最新的 go-livepeer 版本: <Badge color="green">{latestVersion}</Badge> (动态获取)

本指南涵盖在 Linux 上从源二进制文件安装 Livepeer 网关。
...
跳转至 [配置](/v2/gateways/run-a-gateway/configure/configuration-overview) 完成
配置网关

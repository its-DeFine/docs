...
title: 网关节点要求
sidebarTitle: 要求
description: 了解运行 Livepeer 网关所需的硬件、网络和软件要求。
icon: clipboard-user
keywords:
  - livepeer
  - gateways
...
---
{/* codex-i18n:  */}
...
- <Icon icon="link" size={18} /> **在线** -> 连接到基于区块链的 Livepeer 网络的生产模式。{' '}

## 网关功能

您可以运行一个网关用于：

- <Badge color="blue"> Video Only </Badge> -> 传统的转码服务
- <Badge color="purple"> AI Only </Badge> -> 人工智能推理服务
- <Badge color="green"> Dual: AI & Video </Badge> -> 视频转码和人工智能推理服务两者

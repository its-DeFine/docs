---
title: 链上设置要求
description: 本页将指导您完成在链上模式运行网关所需的额外设置，包括查找 RPC URL、创建以太坊账户和密钥库。
sidebarTitle: 链上设置
icon: chain
keywords:
  - livepeer
...
---
{/* codex-i18n:  */}
...
<Columns cols={3}>
    ...
    <div>
        Related Pages
        - [Run a Gateway](/v2/cn/gateways/run-a-gateway/quickstart/quickstart-a-gateway)
        - [Fund Gateway](./fund-gateway)
        - [Install Gateway](/v2/gateways/run-a-gateway/install/install-overview)
        - [RPC Reference](/v2/cn/gateways/references/arbitrum-rpc)
    </div>
...
Livepeer 当前部署在 [Arbitrum](https://docs.arbitrum.io/build-decentralized-apps/public-chains#arbitrum-one) L2 网络（Arbitrum One）。

为了与 [Livepeer 智能合约](../../../../resources/references/contract-addresses) 您需要连接到 Arbitrum RPC。
...
## <Icon icon="fast-forward" size={24} /> 使用 Livepeer 工具轻松设置
...
>
  ...
  -> then come back to this guide.{' '}
    ...
    Livepeer 将在您首次 [安装您的网关软件](/v2/gateways/run-a-gateway/install/install-overview).
    ...
    使用以下命令快速启动一个链上网关，使用新钱包并自动生成所有必需参数。

    查看 [RPC URL](#rpc-url) 以获取有关查找或使用替代 Arbitrum RPC URL 的说明。

...
<PortalContentContainer>
  ...
  <Columns cols={2}>
    <Card
      ...
      href="./products/daydream/daydream"
      arrow
    >
    ...
    <Card
      ...
      icon="cube"
      href="./products/livepeer-studio/overview/overview"
      arrow
    >
    ...
    <Card
      title="Frameworks"
      icon="circle-nodes"
      href="./products/frameworks/frameworks"
      arrow
    >
    ...
    <Card
      title="Stream.place"
      icon="book"
      href="./products/streamplace/streamplace"
      arrow
    >
    ...
    <Card
      ...
      icon="book"
      href="./products/all-ecosystem/product-hub"
      arrow
    >
      A comprehensive glossary of terms used in the Livepeer Real-time Video AI Network.
    </Card>

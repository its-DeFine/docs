---
title: "Webhooks"
description: "Receive real-time events from Livepeer Studio (stream, asset, recording, multistream, task, access control)."
---
...
See [Listen to events](listen-to-events) for asset/stream event usage and [Access control with webhooks](access-control/webhooks) for gated playback.

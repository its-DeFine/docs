...
<Info>
  Use separate accounts or [projects](/platforms/products/livepeer-studio/guides/managing-projects) for development and production to keep environments isolated.
</Info>
...
- [Create a livestream](/platforms/products/livepeer-studio/guides/create-livestream) — Create a stream and get a stream key and playback ID.
- [Upload an asset](/platforms/products/livepeer-studio/guides/upload-asset) — Upload video files and play them back.
- [Listen to asset events](/platforms/products/livepeer-studio/guides/listen-to-events) — Use webhooks to react when assets are ready or fail.

...
description: >-
  How Livepeer is governed, who the Livepeer Foundation is, how the treasury
  works, and how to participate in decisions that shape the network.
keywords:
  - livepeer
  - community
  - livepeer community
...
<Note>
 This page covers governance participation and the Foundation's role. For LPT staking mechanics, delegation, and voting weight, see the [Delegators](/v2/delegators) section.
</Note>

...
<AccordionGroup>
  ...
  <Accordion title="Partner with Livepeer" icon="handshake">
    ...
    **Integration, infrastructure, and business partnerships**
    ...
    <LinkArrow href="https://livepeer.org" label="Livepeer Foundation" /> then <LinkArrow href="/v2/community/ecosystem/entities" label="Ecosystem entities" newline={false} />

...
description: >-
  How Livepeer is governed, who the Livepeer Foundation is, how the treasury works, and how to participate in decisions
...
<Note>
 governance participation and the Foundation's role. For LPT staking mechanics, delegation, and voting weight, see the [Delegators](/v2/delegators) section.
</Note>

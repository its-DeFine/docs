...
description: Principales applications de Livepeer du développeur amateur au Fortune 500.
keywords:
  - livepeer
...
---
{/* codex-i18n:  */}
...
### **Secteurs où la vidéo est désormais essentielle**&#x20;
{/* 
...
## **Produits qui n'existeraient pas sans vidéo**

1. **TikTok** (partage de vidéos courtes sur les réseaux sociaux)
2. **Zoom** (conférences vidéo en temps réel)
3. **Twitch** (diffusion en direct de jeux vidéo)
4. **YouTube** (hébergement vidéo ouvert + monétisation des créateurs)
5. **FaceTime/Google Meet** (appels vidéo grand public)
6. **Peloton** (cours de fitness en direct alimentés par la vidéo)
7. **Ring/Nest Cam** (sécurité par caméra en temps réel)
8. **Applications de télésanté** (consultations médicales à distance centrées sur la vidéo)
9. **Plateformes d'éducation en ligne** comme Coursera/Udacity (apprentissage basé sur la vidéo)
10. **Plateformes d'événements virtuels** (Devcon/ETH diffusion CC, alimenté par des infrastructures comme Livepeer)

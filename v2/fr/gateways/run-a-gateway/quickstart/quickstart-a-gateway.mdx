...
---
{/* codex-i18n:  */}
{/* DATA & CODE */}
...
--- 
# Allons-y(-Livepeer) ! <Icon icon="face-grin-wink" size={26} />
Cette page vous permettra de démarrer et de faire fonctionner un nœud Gateway Livepeer pour <Badge color="blue">Video</Badge> Transcodage & <Badge color="purple">AI</Badge> Routage de services Pipeline.

*Ce guide inclut :* 
- Configuration pour <span><Icon icon="link" size={20}/> **on-chain _(production)_** and <Icon icon="floppy-disk" size={20}/> **off-chain _(local/dev)_** Livepeer Gateway nodes </span>
- Guides d'installation pour <span><Icon icon="docker" size={20} /> **Docker _(recommended)_** </span> et <span><Icon icon="laptop-code" size={20} /> **Pre-Built Binaries**. </span>
...
<Columns cols={2}>
  <Card title="Setup Checklist" href="../requirements/setup" arrow horizontal>
    {' '}
    See Prerequisites & Requirements.{' '}
  </Card>
  <Card title="On-Chain Setup" href="../requirements/on-chain%20setup/on-chain" arrow horizontal>
...
It uses defaults for all optional parameters. See the [full setup guide](/v2/fr/gateways/run-a-gateway/run-a-gateway) for more details on customising your Gateway. \*/}

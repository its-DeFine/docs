...
description: Comment installer une passerelle Livepeer sur Windows
sidebarTitle: Installation Windows
icon: windows
keywords:
  - livepeer
  - gateways
...
---
{/* codex-i18n:  */}
...
Dernière version go-livepeer : <Badge color="green">{version}</Badge> (récupéré dynamiquement)

Ce guide couvre l'installation du Livepeer Gateway à partir du binaire source sur Windows.
...
>
  ...
  Options](/v2/fr/gateways/run-a-gateway/configure/configuration-overview) to finish

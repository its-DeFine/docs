---
title: Financer le Livepeer Gateway
sidebarTitle: Financer le Gateway
icon: ethereum
description: >-
  Les étapes suivantes vous guideront dans l'ajout de fonds à votre compte ETH,
  y compris le financement du compte ETH sur Ethereum Mainnet, le transfert des
  fonds vers le réseau L2 d'Arbitrum, puis l'utilisation de l'interface CLI
  Livepeer pour allouer les montants de dépôt et de réserve appropriés.
keywords:
  - livepeer
  - gateways
  - run a gateway
...
---
{/* codex-i18n:  */}
import { StyledSteps, StyledStep } from '/snippets/components/layout/steps.jsx'

<Warning> Complete: needs review </Warning>

# Ajouter des fonds au portefeuille de passerelle

Pour faire fonctionner le Gateway en production, vous devez avoir de l'Éthereum sur[Arbitrum Un](https://arbitrum.io/) Blockchain L2 - qui est là où les contrats intelligents de Livepeer sont déployés et qui fournit la couche de paiement pour Livepeer.
...
<StyledSteps>
  <StyledStep title="Buy Ethereum" titleSize="h2">
    ...
    <Card icon="books" title="Exchanges that support Arbitrum One" href="/v2/gateways/references/artibtrum-exchanges" arrow horizontal>

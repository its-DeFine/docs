...
## Delegators
- [Delegators Home Portal](delegators/portal.mdx)
...
#### Reference
- [LPT Token Glossary](delegators/resources/reference/glossary.mdx)
...
- [Fund The Livepeer Gateway](gateways/setup/requirements/on-chain-setup/fund-gateway.mdx)

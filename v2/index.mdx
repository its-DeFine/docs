...
### Concepts
- [⚠️ Livepeer Actors](about/concepts/actors.mdx)
...
### Resources
- [⚠️ Blockchain Contracts](about/resources/blockchain-contracts.mdx)
- [⚠️ Gateways Vs. Orchestrators: What’s the Difference?](about/resources/gateways-vs-orchestrators.mdx)
- [Canonical Contract Addresses](about/resources/livepeer-contract-addresses.mdx)
...
- [Livepeer Glossary](about/resources/compendium/livepeer-glossary.mdx)
...
## Delegators
- [Delegators Home Portal](delegators/token-portal.mdx)

### About
- [LPT Mechanics](delegators/about/mechanics.mdx)
- [LPT Overview](delegators/about/overview.mdx)
- [Livepeer Token Purpose](delegators/about/purpose.mdx)
- [LPT Tokenomics](delegators/about/tokenomics.mdx)

### Delegation
- [About Delegators](delegators/delegation/about-delegators.mdx)
...
- [Delegation Guide](delegators/delegation/delegation-guide.mdx)
- [Delegating LPT: Getting Started](delegators/delegation/getting-started.mdx)
- [Delegation Overview](delegators/delegation/overview.mdx)

### Governance
- [Livepeer Governance Model](delegators/governance/model.mdx)
- [Livepeer Governance Overview](delegators/governance/overview.mdx)
- [Livepeer Governance Processes](delegators/governance/processes.mdx)

### Resources
- [Delegator Videos and Blogs](delegators/resources/delegator-videos-and-blogs.mdx)
- [Exchanges with LPT Listed](delegators/resources/exchanges.mdx)
- [LPT & ETH Token Functions](delegators/resources/lpt-eth-usage.mdx)

#### Compendium
- [LPT Token Glossary](delegators/resources/compendium/glossary.mdx)

### Treasury
- [Treasury Allocations](delegators/treasury/allocations.mdx)
- [Treasury Overview](delegators/treasury/overview.mdx)
- [Treasury Proposals](delegators/treasury/proposals.mdx)
...
- [Contract Addresses](developers/guides/testnet-contract-deployment.mdx)
...
- [Gateway Terminology Glossary](gateways/resources/reference/glossary.mdx)

##### Compendium
- [Gateway Glossary](gateways/resources/reference/compendium/glossary.mdx)
...
##### Technical
- [Arbitrum Exchange Reference](gateways/resources/reference/technical/arbitrum-exchanges.mdx)
- [Arbitrum RPCs](gateways/resources/reference/technical/arbitrum-rpc.mdx)
...
- [Livepeer Exchanges](gateways/resources/reference/technical/livepeer-exchanges.mdx)
...
- [Orchestrator Terminology Glossary](orchestrators/resources/reference/glossary.mdx)
- [GPU Support Matrix](orchestrators/resources/reference/gpu-support.mdx)

##### Compendium
- [Orchestrator Glossary](orchestrators/resources/reference/compendium/glossary.mdx)
...
- [Monitoring Your Orchestrator Setup](orchestrators/setup/r-monitor.mdx)
- [Operational and Hardware Requirements for Orchestrators](orchestrators/setup/rcs-requirements.mdx)
...
- [Resource Hub](resources/portal.mdx)

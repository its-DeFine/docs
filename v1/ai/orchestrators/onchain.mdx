  ...
  <Tab title="Use Arbitrum Explorer">
    ...
    <Steps>
        ...
        <Step title="Open the Contract page in the Arbitrum Explorer">
            ...
            <Frame>![AIServiceRegistry Contract Page](/v1/images/ai/ai-serviceregistry-explorer-page.png)</Frame>
        </Step>
...
be successfully set.
            ...
            <Frame>![SetServiceURI](/v1/images/ai/ai-serviceregistry-setserviceuri.png)</Frame>
        </Step>

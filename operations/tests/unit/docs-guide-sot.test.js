...
function checkGeneratedIndexFreshness(errors) {
  const checks = [
    {
      args: ['operations/scripts/generators/governance/catalogs/generate-docs-guide-indexes.js', '--check'],
    ...
    {
      args: ['operations/scripts/generators/governance/catalogs/generate-docs-guide-pages-index.js', '--check'],
    ...
    {
      args: ['operations/scripts/generators/governance/catalogs/generate-docs-guide-components-index.js', '--check'],
    ...
    {
      args: ['operations/scripts/generators/components/library/generate-ui-templates.js', '--check'],
  ...
  checks.forEach((check) => {
    ...
    if (check.args[0] === 'operations/scripts/generators/components/library/generate-ui-templates.js') {

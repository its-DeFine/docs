 ...
 * @scope             tests/unit, operations/scripts/redirects, tools/data/redirects, docs.json
 * @domain            docs
 * @needs             E-C1, R-R14
...
const syncTool = require('../../scripts/x-archive/sync-legacy-root-v1');
...
function writeLegacyFallbackPage(repoRoot, source) {
  writeFile(
    ...
    [
      ...
      'Generation Script: operations/scripts/redirects/sync-legacy-root-v1.js',
      'Purpose: Legacy generated fallback page',
      'Run when: Never',
      'Run command: node operations/scripts/redirects/sync-legacy-root-v1.js --write',
      '*/}',
      '',
      '# Legacy fallback',
      ''

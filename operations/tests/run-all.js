...
const doubleHeadersValidator = require('../scripts/validators/content/structure/check-double-headers');
const mdxSafeMarkdownValidator = require('../scripts/validators/content/structure/check-mdx-safe-markdown');
const pagesIndexGenerator = require('../scripts/generators/content/catalogs/generate-pages-index');
...
function hasStagedDocsGuideSotChanges() {
  ...
  return getStagedRepoRelativeFiles().some(
    (filePath) =>
      ...
      filePath === 'operations/tests/unit/docs-guide-sot.test.js' ||
      filePath.startsWith('operations/scripts/generators/governance/catalogs/generate-docs-guide-') ||
      filePath === 'operations/scripts/generators/components/library/generate-ui-templates.js' ||
      filePath === 'operations/tests/unit/script-docs.test.js'
  );
}

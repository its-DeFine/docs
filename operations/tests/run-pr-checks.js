...
function runCodexTaskContractCheck(branch, changedFiles, baseRef) {
  ...
  const args = ['operations/scripts/validators/governance/compliance/validate-codex-task-contract.js', '--branch', branch];
...
function createBranchHealthRegistry(context) {
  ...
  return [
    ...
    createCommandCheck({
      ...
      files: groups.docsMdxAbs,
      args: ['operations/tests/unit/mdx.test.js', ...buildFilesArgs(groups.docsMdxAbs)]
    }),
    createCommandCheck({
    ...
    createCommandCheck({
      label: 'Spelling',
      files: groups.docsMdxAbs,
      args: ['operations/tests/unit/spelling.test.js', ...buildFilesArgs(groups.docsMdxAbs)]
    }),
    createCommandCheck({
      label: 'Quality',
      files: groups.docsMdxAbs,

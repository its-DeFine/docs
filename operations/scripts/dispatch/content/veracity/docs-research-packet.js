...
function runTranche(tranche, args, validation, outputRoot) {
  ...
  const pageRun = runNodeScript('operations/scripts/docs-page-research.js', [
    '--registry',
    args.registry,
    '--files',
    filesArg,
  ...
  const prRun = runNodeScript('operations/scripts/docs-page-research-pr-report.js', [
    '--registry',
    args.registry,
    '--files',
    filesArg,
...
function runPacket(args) {
  ...
  const validation = {
    registryValidate: runNodeScript('operations/scripts/docs-fact-registry.js', ['--validate', '--registry', args.registry]),
    adjudicationValidate: runNodeScript('operations/scripts/docs-research-adjudication.js', ['--validate', '--ledger', args.ledger])
  };

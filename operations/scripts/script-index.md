...
| `operations/scripts/automations/content/language-translation/test/cli-guardrails.test.js` | Tests i18n CLI guardrails — validates argument validation and safety checks | `node operations/scripts/i18n/test/cli-guardrails.test.js [flags]` | docs |
| `operations/scripts/automations/content/language-translation/test/docs-json-localizer.test.js` | Tests docs-json-localizer — validates locale docs.json transformation logic | `node operations/scripts/i18n/test/docs-json-localizer.test.js [flags]` | docs |
| `operations/scripts/automations/content/language-translation/test/frontmatter.test.js` | Tests frontmatter parser — validates frontmatter read/write roundtrip | `node operations/scripts/i18n/test/frontmatter.test.js [flags]` | docs |
| `operations/scripts/automations/content/language-translation/test/mdx-translate.test.js` | Tests MDX translation — validates content block translation logic | `node operations/scripts/i18n/test/mdx-translate.test.js [flags]` | docs |
| `operations/scripts/automations/content/language-translation/test/provenance.test.js` | Tests provenance tracker — validates translation provenance recording | `node operations/scripts/i18n/test/provenance.test.js [flags]` | docs |
| `operations/scripts/automations/content/language-translation/test/provider-openrouter.test.js` | Tests OpenRouter provider — validates API call logic and response parsing | `node operations/scripts/i18n/test/provider-openrouter.test.js [flags]` | docs |
| `operations/scripts/remediators/content/repair/repair-relative-page-hrefs.js` | Convert publishable v2 page href string literals from page-relative paths to canonical root-level /v2/... routes without touching non-page targets. | `node operations/scripts/remediators/content/repair/repair-relative-page-hrefs.js --dry-run --files v2/about --report-dir workspace/reports/relative-link-audit` | docs |

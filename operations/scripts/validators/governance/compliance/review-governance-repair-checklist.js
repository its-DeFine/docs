...
function buildChecklistReport() {
  ...
  return {
    ...
    source: {
      mode: 'dry-run-plan',
      script: 'operations/scripts/validators/governance/review-governance-repair-checklist.js',
      audit_script: 'operations/scripts/validators/governance/audit-script-inventory.js'
    },

 ...
 * @description Rewrites relative internal page href string literals in publishable v2 docs pages to canonical root-level routes and audits unresolved targets.
 * @mode        edit
 * @domain      docs
 * @needs       E-R12, E-R14
 * @purpose-statement Convert publishable v2 page href string literals from page-relative paths to canonical root-level /v2/... routes without touching non-page targets.
 * @pipeline    manual
 * @scope       v2 publishable docs pages, workspace/reports/relative-link-audit
 * @usage       node operations/scripts/remediators/content/repair/repair-relative-page-hrefs.js --dry-run --files v2/about --report-dir workspace/reports/relative-link-audit
 * @policy      E-R12, E-R14
 */
...
const DEFAULT_REPORT_DIR = 'workspace/reports/relative-link-audit';
...
function printHelp() {
  console.log(
    [
      'Usage:',
      '  node operations/scripts/remediators/content/repair/repair-relative-page-hrefs.js [--dry-run|--write] [--files <path[,path...]>] [--report-dir <dir>] [--json]',
      '',
      'Modes:',
...
function buildMarkdownReport(result) {
  const lines = [];
  lines.push('# Relative Link Audit');
  lines.push('');
  lines.push('## Summary');

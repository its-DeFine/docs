    ...
    deployments: [
      ...
      controllerDeployment({
        ...
        codeAuthority: {
          repo: "livepeer/protocol",
          branch: "delta",
          path: "contracts/treasury/BondingVotes.sol",
        },
        currentImplementationStrategy: {
          kind: "governor-versioned-latest",
      ...
      controllerDeployment({
        ...
        codeAuthority: {
          repo: "livepeer/arbitrum-lpt-bridge",
          branch: "main",
          path: "contracts/L2/migration/L2Migrator.sol",
        },
      }),
      controllerDeployment({
      ...
      bridgeDeployment({
        ...
        codeAuthority: {
          repo: "livepeer/arbitrum-lpt-bridge",
          branch: "main",
          path: "contracts/L1/token/BridgeMinter.sol",
        },
      }),
      bridgeDeployment({
      ...
      bridgeDeployment({
        ...
        chain: "ethereumMainnet",
        governorKey: "l1Escrow",
        codeAuthority: {
          repo: "livepeer/arbitrum-lpt-bridge",
          branch: "main",
          path: "contracts/L1/token/L1Escrow.sol",
        },
      }),
      bridgeDeployment({
      ...
      bridgeDeployment({
        ...
        codeAuthority: {
          repo: "livepeer/arbitrum-lpt-bridge",
          branch: "main",
          path: "contracts/L1/migration/L1Migrator.sol",
        },
      }),
      controllerDeployment({

...
function buildTopReadme(pipelineSkills) {
  ...
  lines.push('');
  lines.push('Generated by: `node operations/scripts/automations/ai/agents/cross-agent-packager.js --agent-pack all`');
  lines.push('');
  return `${lines.join('\n')}\n`;
}
...
function buildRulePackMarkdown(agentName, pipelineSkills, referenceSkills) {
  ...
  lines.push('Run source: `node operations/scripts/automations/ai/agents/cross-agent-packager.js --agent-pack all`');
  lines.push('');
  return `${lines.join('\n')}\n`;
}

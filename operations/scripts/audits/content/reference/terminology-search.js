...
try {
  require('dotenv').config({ path: path.join(process.cwd(), 'operations/scripts/audits/content/reference/.env') });
} catch (_error) {
...
const OUTPUT_DIR = path.join(REPO_ROOT, 'operations/scripts/audits/content/data');

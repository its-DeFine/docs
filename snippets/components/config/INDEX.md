...
|---|---|---|---|---|---|---|
| 1 | **MermaidColours** | `MermaidColours.jsx` | none | 🟢 stable | 0 | Theme colour definitions for Mermaid diagrams (light/dark/CSS variable mappings)... |

---

**Status key:** 🟢 stable · 🧪 experimental · 🟠 deprecated · 🔴 broken · ⬜ placeholder · 📋 planned

**Total:** 1 components | **Stable:** 1

...
- [gateways portal](/v2/gateways/gateways-portal)
...
- [choosing a gateway](/v2/gateways/using-gateways/choosing-a-gateway)
- [gateway providers](/v2/gateways/using-gateways/gateway-providers)
- [daydream gateway](/v2/gateways/using-gateways/gateway-providers/daydream-gateway)
- [livepeer studio gateway](/v2/gateways/using-gateways/gateway-providers/livepeer-studio-gateway)
- [cloud spe gateway](/v2/gateways/using-gateways/gateway-providers/cloud-spe-gateway)
- streamplace ⚠️ missing-route

### Run A Gateway

- [quickstart a gateway](/v2/gateways/run-a-gateway/quickstart/quickstart-a-gateway)
- [get AI to setup the gateway.mdx](/v2/gateways/run-a-gateway/quickstart/get-AI-to-setup-the-gateway.mdx)
- [why run a gateway](/v2/gateways/run-a-gateway/why-run-a-gateway)
- [run a gateway](/v2/gateways/run-a-gateway/run-a-gateway)

### Gateway Tools & Resources

- [explorer](/v2/gateways/gateway-tools/explorer)
- [livepeer tools](/v2/gateways/gateway-tools/livepeer-tools)
- [community guides](/v2/gateways/guides-and-resources/community-guides)
- [community projects](/v2/gateways/guides-and-resources/community-projects)
- [faq](/v2/gateways/guides-and-resources/faq)

### Technical References

- [technical architecture](/v2/gateways/references/technical-architecture)
- [configuration flags](/v2/gateways/references/configuration-flags)
- video flags ⚠️ missing-route
- [cli commands](/v2/gateways/references/cli-commands)
- [livepeer exchanges](/v2/gateways/references/livepeer-exchanges)
- [artibtrum exchanges](/v2/gateways/references/artibtrum-exchanges)
- [arbitrum rpc](/v2/gateways/references/arbitrum-rpc)

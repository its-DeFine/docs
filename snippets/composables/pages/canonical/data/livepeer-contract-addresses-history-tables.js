...
const getPausedTableItems = (sourceData = {}) => [
...
const getMigrationResidualTableItems = (sourceData = {}) => [
...
const getLegacyOperationalTableItems = (sourceData = {}) => [
  ...normalizeContractsForTable(
    sourceData,
...
export { getPausedTableItems, getMigrationResidualTableItems, getLegacyOperationalTableItems }

...
{/*
THIS NEEDS TARGET CONTRACTS with the related proxy contract in another column
Also change header colors for categories or instead just put them in a column
*/}
...
{/* This accordion should provide
- pipeline details (mermaid diagram)
- cadence / runtimes
...
{/* WTF WITH THESE - MDX pages shouldn't have all this data in them...  */}

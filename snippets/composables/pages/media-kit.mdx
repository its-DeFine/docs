...
<WidthCard width="60%" cardProps={{ title: "Visit the Media Page", href: "https://www.livepeer.org/media-kit", icon: "aperture", horizontal: true }} />
...
<br/>
<CenteredContainer preset="readable80" style={{minWidth: 'fit-content'}}>
    <DownloadButton

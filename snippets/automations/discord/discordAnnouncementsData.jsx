export const discordAnnouncementsData = [
  ...
  },
  {
    ...
    content:
      "📣 <strong>__Vote now on the Protocol R&amp;D SPE__</strong> 🗳️ 📣 <br /><br />All network value depends on protocol security. The proposal argues for a dedicated, continuously staffed function for protocol security, upgrades, and core improvements, replacing the current ad hoc model with a single accountable structure.<br /><br />Vote Yes ✅ or No ❌ [here](https://explorer.livepeer.org/treasury/67253869199932483234551664403036205881217777786063955710174984983936506090761)",
    author: "AlisonWonderland",
...
export const DiscordAnnouncementsOld = () => {
  const announcements = discordAnnouncementsData;
    ...
    <div className="discord-announcements">
      ...
      <div className="announcements-list space-y-4 mt-4">
        {announcements.map((announcement) => (
          <div
            key={announcement.id}
            className="announcement-card border rounded-lg p-4"
          >

 ...
 * @scope             tools/lib, ai-tools/registry, operations/scripts/validators/governance/compliance/validate-ai-tools-registry.js, operations/tests/unit/ai-tools-registry.test.js, docs-guide/tooling/ai-tools.mdx, docs-guide/policies/source-of-truth-policy.mdx, tools/config/ownerless-governance-surfaces.json
 * @domain            docs
 * @needs             R-R14, R-R29
...
function renderInventoryReport(registry, validation = {}) {
  ...
  const lines = [
    '{/* Generated by node operations/scripts/validators/governance/compliance/validate-ai-tools-registry.js --write-report. Do not edit directly. */}',
    '',
    '# AI-Tools Inventory',
    '',
    ...
    validation.summary && validation.summary.trackedFiles
      ...
      : '- Tracked AI-tools files covered: run `node operations/scripts/validators/governance/compliance/validate-ai-tools-registry.js --check --coverage` to confirm',
    ''
  ];

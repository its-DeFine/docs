 ...
 * @scope             tools/lib, ai-tools/registry, operations/scripts/validate-ai-tools-registry.js, tests/unit/ai-tools-registry.test.js, docs-guide/tooling/ai-tools.mdx, docs-guide/policies/source-of-truth-policy.mdx, tools/config/ownerless-governance-surfaces.json
 * @domain            docs
 * @needs             R-R14, R-R29
...
function renderInventoryReport(registry, validation = {}) {
  ...
  const lines = [
    '{/* Generated by node operations/scripts/validate-ai-tools-registry.js --write-report. Do not edit directly. */}',
    '',
    '# AI-Tools Inventory',
    '',

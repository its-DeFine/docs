...
Generated: 2026-02-21T03:54:26.409Z
...
## Summary
- Total scripts: 87
- Template compliant: 84
- Template non-compliant: 3
- Exact overlap clusters: 10
...
| `tasks/scripts/audit-all-pages-simple.js` | Utility script for tasks/scripts/audit-all-pages-simple.js. | PASS | audit | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
| `tasks/scripts/audit-all-pages.js` | Utility script for tasks/scripts/audit-all-pages.js. | PASS | audit | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
| `tasks/scripts/audit-component-usage.js` | Utility script for tasks/scripts/audit-component-usage.js. | PASS | audit | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
...
| `tasks/scripts/run-audit-direct.sh` | Utility script for tasks/scripts/run-audit-direct.sh. | PASS | audit, runner | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
...
| `tasks/scripts/run-audit.sh` | Utility script for tasks/scripts/run-audit.sh. | PASS | audit, runner | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
...
| `tests/integration/domain-pages-audit.js` | Audit deployed docs page load status and emit a stable JSON report. | PASS | audit, enforcement, hook, test | manual, npm-script, pre-commit | hook:.githooks/pre-commit#line 522 [pre-commit] \| hook:.githooks/pre-commit#line 592 [pre-commit] \| package-script:tests/package.json#scripts.test:domain [manual,npm-script] \| package-script:tests/package.json#scripts.test:domain:both [manual,npm-script] \| package-script:tests/package.json#scripts.test:domain:v1 [manual,npm-script] \| package-script:tests/package.json#scripts.test:domain:v2 [manual,npm-script] |
| `tests/integration/v2-link-audit.js` | Comprehensive V2 MDX link audit with report and domain link map outputs. | FAIL (missing @examples, @notes) | audit, enforcement, hook, test | manual, npm-script, pre-commit | hook:.githooks/pre-commit#line 507 [pre-commit] \| hook:.githooks/pre-commit#line 577 [pre-commit] \| package-script:tests/package.json#scripts.test:link-audit [manual,npm-script] \| package-script:tests/package.json#scripts.test:link-audit:staged [manual,npm-script] |
| `tests/run-all.js` | Utility script for tests/run-all.js. | PASS | enforcement, hook, runner, test | manual, npm-script, pre-commit | hook:.githooks/pre-commit#line 460 [pre-commit] \| hook:.githooks/pre-commit#line 494 [pre-commit] \| hook:.githooks/pre-commit#line 564 [pre-commit] \| package-script:tests/package.json#scripts.test [manual,npm-script] \| package-script:tools/package.json#scripts.test [manual,npm-script] |
...
| `tests/unit/script-docs.test.js` | Enforce script header schema, keep group script indexes in sync, and build aggregate script index. | PASS | enforcement, generator, hook, sync, test | manual, npm-script, pre-commit | hook:.githooks/pre-commit#line 469 [pre-commit] \| hook:.githooks/pre-commit#line 539 [pre-commit] \| package-script:tests/package.json#scripts.test:scripts [manual,npm-script] |
...
| `tools/scripts/snippets/generate-docs-status.js` | Utility script for tools/scripts/snippets/generate-docs-status.js. | PASS | generator | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
| `tools/scripts/snippets/generate-seo.js` | Utility script for tools/scripts/snippets/generate-seo.js. | PASS | generator | manual, npm-script | package-script:v2/package.json#scripts.generate-seo [manual,npm-script] \| package-script:v2/package.json#scripts.generate-seo:dry-run [manual,npm-script] |
...
| `tools/scripts/test/verify-all-pages.js` | Utility script for tools/scripts/test/verify-all-pages.js. | PASS | enforcement, fixture | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
| `tools/scripts/test/verify-pages.js` | Utility script for tools/scripts/test/verify-pages.js. | PASS | enforcement, fixture | manual | Manual/on-demand (no direct hook/workflow/package reference found) |
...
### `tasks/scripts/audit-all-pages-simple.js`
...
### `tasks/scripts/audit-all-pages.js`
...
### `tasks/scripts/audit-component-usage.js`
- Purpose: Utility script for tasks/scripts/audit-component-usage.js.
- Template compliance: PASS
- Role tags: audit
- Run-context tags: manual
- Used by: Manual/on-demand (no direct hook/workflow/package reference found)
...
### `tasks/scripts/run-audit-direct.sh`
- Purpose: Utility script for tasks/scripts/run-audit-direct.sh.
- Template compliance: PASS
...
### `tasks/scripts/run-audit.sh`
- Purpose: Utility script for tasks/scripts/run-audit.sh.
- Template compliance: PASS
- Role tags: audit, runner
- Run-context tags: manual
- Used by: Manual/on-demand (no direct hook/workflow/package reference found)
...
- Used by:
  - hook: .githooks/pre-commit#line 522 (when: pre-commit)
...
- Template compliance: FAIL (missing @examples, @notes)
- Role tags: audit, enforcement, hook, test
- Run-context tags: manual, npm-script, pre-commit
- Used by:
  - hook: .githooks/pre-commit#line 507 (when: pre-commit)
  - hook: .githooks/pre-commit#line 577 (when: pre-commit)
...
- Used by:
  ...
  - hook: .githooks/pre-commit#line 494 (when: pre-commit)
...
- Used by:
  ...
  - hook: .githooks/pre-commit#line 539 (when: pre-commit)
...
- Purpose: Generate and verify section-style index.mdx files for v2/pages folders, plus the root aggregate index.
- Template compliance: PASS
- Role tags: enforcement, generator, hook
- Run-context tags: manual, npm-script, pre-commit
- Used by:
  - hook: .githooks/pre-commit#line 483 (when: pre-commit)
  - hook: .githooks/pre-commit#line 553 (when: pre-commit)
...
- Purpose: Utility script for tools/scripts/snippets/generate-docs-status.js.
- Template compliance: PASS
- Role tags: generator
- Run-context tags: manual
- Used by: Manual/on-demand (no direct hook/workflow/package reference found)
...
- Run-context tags: manual, npm-script
- Used by:
  - package-script: v2/package.json#scripts.generate-seo (when: manual, npm-script)
  - package-script: v2/package.json#scripts.generate-seo:dry-run (when: manual, npm-script)
...
- Purpose: Utility script for tools/scripts/test/verify-all-pages.js.
- Template compliance: PASS
- Role tags: enforcement, fixture
- Run-context tags: manual
- Used by: Manual/on-demand (no direct hook/workflow/package reference found)
...
- Purpose: Utility script for tools/scripts/test/verify-pages.js.
- Template compliance: PASS
- Role tags: enforcement, fixture
- Run-context tags: manual
- Used by: Manual/on-demand (no direct hook/workflow/package reference found)
...
### Cluster 2 (exact)
- Scripts: `tasks/scripts/audit-component-usage.js`, `tools/scripts/audit-component-usage.js`
- Canonical candidate: `tools/scripts/audit-component-usage.js`
- Shared role tags: audit
- Recommendation: Consolidate to `tools/scripts/audit-component-usage.js`; replace duplicates with wrappers or remove after migrating references.
...
- Consolidate to `tools/scripts/audit-component-usage.js`; replace duplicates with wrappers or remove after migrating references.

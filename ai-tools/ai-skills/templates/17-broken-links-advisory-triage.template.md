...
description: Triage advisory broken-links workflow output and convert findings into actionable fix queues.
tier: 2
triggers:
...
primary_commands:
  ...
  - "node tests/integration/v2-link-audit.js --full --strict --report tasks/reports/LINK_TEST_REPORT.md"
---

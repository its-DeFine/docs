...
| [Check Docs Guide Catalogs](./check-docs-guide-catalogs.mdx) | `docs-catalog-governance` | `merge` | `active` | `core-shipping` | `repo-ops` | `low` | `review-fix` | `pull_request + push + workflow_dispatch` | `future:docs-catalog-governance-workflow` |
| [Check Docs Index](./check-docs-index.mdx) | `docs-catalog-governance` | `merge` | `active` | `core-shipping` | `repo-ops` | `low` | `review-fix` | `pull_request + push + workflow_dispatch` | `future:docs-catalog-governance-workflow` |
...
| [Generate Component Registry](./generate-component-registry.mdx) | `docs-catalog-governance` | `merge` | `active-mutating` | `core-shipping` | `repo-ops` | `high` | `review-fix` | `push + workflow_dispatch` | `future:docs-catalog-governance-workflow` |
| [Generate Docs Guide Catalogs](./generate-docs-guide-catalogs.mdx) | `docs-catalog-governance` | `merge` | `active-mutating` | `core-shipping` | `repo-ops` | `high` | `page-ship` | `push + workflow_dispatch` | `future:docs-catalog-governance-workflow` |
| [Generate Docs Index](./generate-docs-index.mdx) | `docs-catalog-governance` | `merge` | `active-mutating` | `core-shipping` | `repo-ops` | `high` | `page-ship` | `push + workflow_dispatch` | `future:docs-catalog-governance-workflow` |
...
| [Update Discord Announcements Data](./update-discord-data.mdx) | `data-refresh` | `consolidate` | `active-mutating` | `core-shipping` | `authoring` | `high` | `page-ship` | `schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |
| [Update Forum Data](./update-forum-data.mdx) | `data-refresh` | `needs-investigation` | `legacy-unclear` | `legacy-or-unclear` | `authoring` | `high` | `page-ship` | `schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |
| [Update Ghost Blog Data](./update-ghost-blog-data.mdx) | `data-refresh` | `consolidate` | `active-mutating` | `core-shipping` | `authoring` | `high` | `page-ship` | `schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |
| [Update GitHub Discussions & Releases Data](./update-github-data.mdx) | `data-refresh` | `consolidate` | `active-mutating` | `core-shipping` | `authoring` | `high` | `page-ship` | `schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |
| [Update Livepeer Release Version](./update-livepeer-release.mdx) | `data-refresh` | `consolidate` | `active-mutating` | `core-shipping` | `release` | `high` | `page-ship` | `repository_dispatch + schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |
...
| [Update RSS Blog Data](./update-rss-blog-data.mdx) | `data-refresh` | `consolidate` | `active-mutating` | `core-shipping` | `authoring` | `high` | `page-ship` | `schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |
| [Update YouTube Data](./update-youtube-data.mdx) | `data-refresh` | `needs-investigation` | `legacy-unclear` | `legacy-or-unclear` | `authoring` | `high` | `page-ship` | `schedule + workflow_dispatch` | `future:data-refresh-dispatcher` |

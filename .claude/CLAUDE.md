...
| Styles Governance | Full pipeline: audit validator (6 categories), remediator (5 fix types, idempotent), GH Actions workflow, style guide (10 new sections), WCAG focus-visible + responsive CSS, CoinGecko exchanges + go-livepeer config flags pipelines, badge reference, engineering guide. 98.1% violation reduction (3,986 → 74). 69 mermaid variants deferred | Done | 2026-04-08 |

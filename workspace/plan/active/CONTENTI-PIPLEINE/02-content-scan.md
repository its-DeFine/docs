...
| 15 | v2/orchestrators/setup/rcs-requirements.mdx | Setup Checklist | how_to | current | Pre-flight checklist by node mode (Video/AI/Dual). Hardware tables per mode. | S4 |

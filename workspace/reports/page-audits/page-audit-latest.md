...
- `v2/community/portal`
- `v2/community/connect/guidelines`
- `v2/community/ecosystem/governance`
- `v2/community/community/trending-topics`
- `v2/community/community/livepeer-latest-topics`
- `v2/community/community/roadmap`
- `v2/community/connect/connect-channels`
- `v2/community/connect/news-and-socials`
- `v2/community/connect/events-and-streams`
- `v2/community/contribute/contribute`
- `v2/community/contribute/opportunities`
- `v2/community/contribute/build-livepeer`
...
These pages are intentional redirects and should not be reported as errors:

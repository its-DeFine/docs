...
| **tools/scripts** |  |  |  |
| `tools/scripts/audit-all-v2-pages.js` | Utility script for tools/scripts/audit-all-v2-pages.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/audit-all-v2-pages.js` |
...
| `tools/scripts/check-component-errors.js` | Utility script for tools/scripts/check-component-errors.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/check-component-errors.js` |
...
| `tools/scripts/download-linkedin-video.sh` | Utility script for tools/scripts/download-linkedin-video.sh. | Manual/on-demand (no direct hook/workflow reference found) | `bash tools/scripts/download-linkedin-video.sh` |
| `tools/scripts/download-linkedin-with-cookies.sh` | Utility script for tools/scripts/download-linkedin-with-cookies.sh. | Manual/on-demand (no direct hook/workflow reference found) | `bash tools/scripts/download-linkedin-with-cookies.sh` |
| `tools/scripts/final-verification.js` | Utility script for tools/scripts/final-verification.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/final-verification.js` |
| `tools/scripts/find-correct-url.js` | Utility script for tools/scripts/find-correct-url.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/find-correct-url.js` |
...
| `tools/scripts/inspect-page.js` | Utility script for tools/scripts/inspect-page.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/inspect-page.js` |
| `tools/scripts/inspect-video-page.js` | Utility script for tools/scripts/inspect-video-page.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/inspect-video-page.js` |
...
| `tools/scripts/snippets/generate-docs-status.js` | Utility script for tools/scripts/snippets/generate-docs-status.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/snippets/generate-docs-status.js` |
...
| `tools/scripts/test-all-pages-browser.js` | Utility script for tools/scripts/test-all-pages-browser.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/test-all-pages-browser.js` |
| `tools/scripts/test-all-pages-comprehensive.js` | Utility script for tools/scripts/test-all-pages-comprehensive.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/test-all-pages-comprehensive.js` |
...
| `tools/scripts/test-youtube-pages.js` | Utility script for tools/scripts/test-youtube-pages.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/test-youtube-pages.js` |
...
| `tools/scripts/verify-all-pages.js` | Utility script for tools/scripts/verify-all-pages.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/verify-all-pages.js` |
| `tools/scripts/verify-pages.js` | Utility script for tools/scripts/verify-pages.js. | Manual/on-demand (no direct hook/workflow reference found) | `node tools/scripts/verify-pages.js` |

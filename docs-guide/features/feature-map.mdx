...
- Route and page index synchronization via `operations/scripts/generate-pages-index.js`.
...
- Validation and enforcement scripts across `tests/`, `.githooks/`, and `operations/scripts/`.
...
- `operations/scripts/new-script.js`
- `operations/scripts/audit-scripts.js`
...
- Generated template preview routes and authoring snippets via `operations/scripts/generate-ui-templates.js`.
...
- `operations/scripts/generate-ui-templates.js`

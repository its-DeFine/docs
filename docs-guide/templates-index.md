...
| Feature Request (Docs/Site) | Issue | `.github/ISSUE_TEMPLATE/03_feature_request.yml` | Request a new docs/site/platform guidance capability with clear acceptance criteria. | Feature requests | docs-v2, help wanted, status: needs-triage, type: enhancement | docs |

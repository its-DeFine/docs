...
<TabsContainer>
  ...
  | `unit imports.test` | script-specific via `-- <args>` | `operations/tests/unit/imports.test.js` | Validates MDX import paths and snippet imports are resolvable, with repo-wide dry-run support. |

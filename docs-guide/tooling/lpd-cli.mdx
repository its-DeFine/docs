...
<TabsContainer>
  ...
  | `snippets fetch-external-docs` | script-specific via `-- <args>` | `operations/scripts/automations/content/data/fetching/fetch-external-docs.sh` | Utility script for operations/scripts/automations/content/data/fetching/fetch-external-docs.sh. |

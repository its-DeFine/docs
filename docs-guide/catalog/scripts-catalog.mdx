...
The governed script library currently indexes **324** script(s).
...
<Accordion title="📚 Library Modules — 53">
...
<Accordion title="⚠️ Unclassified — 98 scripts need @type">

...
The governed script library currently indexes **309** script(s).
...
flowchart LR
  ...
  subgraph P1["🔴 P1 — Commit Gate (42)"]
    ...
    c8["pre-commit-v1"]
    c9["browser.test.js"]
    c10["v2-link-audit.js"]
    c11["v2-wcag-audit.js"]
    cmore["... 30 more"]
  end

  subgraph P2["🟠 P2 — Push Gate (11)"]
    direction TB
    p0["pre-push"]
  ...
  subgraph P5_P6["🔵 P5/P6 — Scheduled (13)"]
    direction TB
    s0["fetch-forum-data.js"]
    s1["fetch-youtube-data.js"]
    s2["project-showcase-sync.js"]
    s3["scan-component-imports.js"]
    s4["governance-pipeline.js"]
    s5["generate-llms-files.js"]
    s6["generate-component-registry.js"]
    s7["generate-docs-index.js"]
    s8["generate-ai-sitemap.js"]
    s9["repair-component-metadata.js"]
    s10["openapi-reference-audit.js"]
    s11["v2-link-audit.js"]
    smore["... 1 more"]
  end
...
| `fetch-contract-addresses.js` | Builds the canonical Livepeer contract registry from governor-scripts, | manual | content | `node .github/scripts/fetch-contract-addresses.js [--dry-run] [--skip-verify]` |
...
| `fetch-ghost-blog-data.js` | Fetches Livepeer blog posts via public RSS feed (blog.livepeer.org/rss/). No API key required. Writes to snippets/automations/blog/ghostBlogData.jsx. | manual | content | `node .github/scripts/fetch-ghost-blog-data.js` |
...
| `playwright-contract-addresses.js` | CP-6: Verifies both contract-addresses pages render fully — table, search input, | manual | testing | `node operations/tests/playwright-contract-addresses.js` |
...
| `pre-commit-v1` | Archived pre-commit hook orchestrator that runs structural checks, unit tests, codex validation, and docs-index freshness checks before allowing commit. | P1 | governance | `bash .githooks/pre-commit [flags]` |

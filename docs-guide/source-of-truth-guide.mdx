...
| Features | Major repo systems, automation surfaces, and functional maps | [feature-map.mdx](./features/feature-map.mdx), [architecture-map.mdx](./features/architecture-map.mdx), [automations.mdx](./features/automations.mdx), [data-integrations.mdx](./features/data-integrations.mdx), [ui-system.mdx](./features/ui-system.mdx), [visual-explainer-workflows.mdx](./features/visual-explainer-workflows.mdx), [ai-features.mdx](./features/ai-features.mdx) |
| Tooling | CLI, developer tooling support, and reusable authoring reference maps | [lpd-cli.mdx](./tooling/lpd-cli.mdx), [dev-tools.mdx](./tooling/dev-tools.mdx), [lpd-mdx-preview.mdx](./tooling/lpd-mdx-preview.mdx), [content-brief-template.md](./tooling/content-brief-template.md), [icon-map.mdx](./tooling/reference-maps/icon-map.mdx), [ai-tools.mdx](./tooling/ai-tools.mdx) |
| Frameworks | Decision models, structural guides, and improvement workflows (no enforcement language) | [content-system.mdx](./frameworks/content-system.mdx), [component-governance.mdx](./frameworks/component-governance.mdx), [page-taxonomy-framework.mdx](./frameworks/page-taxonomy-framework.mdx), [research-skill-workflow.mdx](./frameworks/research-skill-workflow.mdx) |
...
| Repo Ops | Operational reference: config files, enforcement maps, secrets | [repo-config-map.mdx](./repoOps/config/repo-config-map.mdx), [enforcement-map.mdx](./repoOps/maps/enforcement-map.mdx), [solutions-secrets.mdx](./repoOps/secrets/solutions-secrets.mdx) |

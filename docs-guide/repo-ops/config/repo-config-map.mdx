...
| `.allowlist` | Pre-commit hook | Generated allowlist of permitted root-level files and directories. Canonical edits happen in `tools/config/runtime/root-governance.json`, then regenerate projections. |

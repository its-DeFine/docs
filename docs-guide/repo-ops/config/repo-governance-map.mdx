...
| `ownerless-governance` | Ownerless Governance | `ownerless-governance` | `pr-changed` | `migrating` | no | `operations/governance/config/ownerless-governance-surfaces.json`<br/>`docs-guide/policies/ownerless-governance.mdx` |  | `human-review-required` | Canonical ownerless-governance manifest under the ownerless steady-state architecture. |

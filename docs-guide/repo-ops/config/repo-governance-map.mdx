...
| `ownerless-governance` | Ownerless Governance | `ownerless-governance` | `pr-changed` | `migrating` | no | `tools/config/runtime/ownerless-governance-surfaces.json`<br/>`docs-guide/policies/ownerless-governance.mdx` |  | `human-review-required` | Ownerless governance remains in migration while the top-level registry is introduced in operations/governance/config. |

...
| 7 | Automations | `snippets/automations/` | `workspace/plan/active/AUTOMATIONS-RESTRUCTURE/plan.md` | Not started |
...
**Root path:** `snippets/automations/`

**Framework:** `workspace/plan/active/AUTOMATIONS-RESTRUCTURE/plan.md`

**Status:** Not started. Blocked on SCRIPT-GOVERNANCE Task 15c completion.
...
These files document platform-level constraints that affect all MDX authoring, component design, and file placement. They are not frameworks but binding constraints. Read both before writing any MDX or JSX.
...
- Decisions log: `.github/workspace/reports-audits/decisions-log.mdx` (D-ACT-01 through D-ACT-08)
- Actions library: `.github/workspace/actions-library/` (41 per-action documentation pages)
- Outcomes: `.github/workspace/outcomes.md` (visual maps and Mermaid diagrams)
...
2. `workspace/thread-outputs/research/mintlify-constraints-reference.md` - platform constraints affecting JSX
...
3. `.github/workspace/reports-audits/decisions-log.mdx` - locked decisions (D-ACT-01 through D-ACT-08)

...
- AI sitemap: `snippets/assets/site/sitemap-ai.xml` (generated by `tools/scripts/generate-ai-sitemap.js`, refreshed via `.github/workflows/generate-ai-sitemap.yml`)
